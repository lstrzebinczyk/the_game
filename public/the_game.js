...
if (tile == null) tile = nil;
            return tile.$content()['$is_a?']((($a = ((($b = $scope.Construction) == null ? $opal.cm('Construction') : $b))._scope).FallenTree == null ? $a.cm('FallenTree') : $a.FallenTree))}, TMP_3._s = self, TMP_3), $a).call($d)
            } else {
            return nil
          };
        };
...
if (tile == null) tile = nil;
            return tile.$content()['$is_a?']((($a = ((($b = $scope.Construction) == null ? $opal.cm('Construction') : $b))._scope).FallenTree == null ? $a.cm('FallenTree') : $a.FallenTree))}, TMP_6._s = self, TMP_6), $a).call($d)
            } else {
            return nil
          };
        };
...
(function($opal) {
  ...
  $opal.add_stubs(['$include', '$attr_reader', '$*', '$==', '$empty?', '$-', '$new', '$!']);
  return (function($base, $super) {
    function $TheGame(){};
    var self = $TheGame = $klass($base, $super, 'TheGame', $TheGame);
    ...
    return (function($base, $super) {
      ...
      return (function($base, $super) {
        function $FallenTree(){};
        var self = $FallenTree = $klass($base, $super, 'FallenTree', $FallenTree);

        var def = self._proto, $scope = self._scope, $a;

        def.firewood_left = nil;
        self.$include((($a = $scope.HasPosition) == null ? $opal.cm('HasPosition') : $a));

        self.$attr_reader("firewood_left");
        ...
        def.$initialize = function(x, y) {
          ...
          self.x = x;
          self.y = y;
          return self.firewood_left = (24)['$*'](7);
        };
        ...
        def.$get = function(type) {
          ...
          if (type['$==']("firewood")) {
            if ((($a = self['$empty?']()) !== nil && (!$a._isBoolean || $a == true))) {
              ...
              self.firewood_left = self.firewood_left['$-'](1);
              return (($a = ((($b = ((($c = $scope.TheGame) == null ? $opal.cm('TheGame') : $c))._scope).Item == null ? $b.cm('Item') : $b.Item))._scope).Firewood == null ? $a.cm('Firewood') : $a.Firewood).$new();
            }
            } else {
            return nil
          };
...
//# sourceMappingURL=/__opal_source_maps__/the_game/construction/fallen_tree.js.map
;
/* Generated by Opal 0.6.2 */
(function($opal) {
  var self = $opal.top, $scope = $opal, nil = $opal.nil, $breaker = $opal.breaker, $slice = $opal.slice, $klass = $opal.klass;
