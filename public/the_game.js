...
(function($opal) {
  ...
  $opal.add_stubs(['$times', '$<<', '$new', '$capacity', '$pop', '$any?', '$size', '$==']);
  return (function($base, $super) {
    function $TheGame(){};
    var self = $TheGame = $klass($base, $super, 'TheGame', $TheGame);
...
(function($opal) {
  ...
  $opal.add_stubs(['$new', '$find', '$on', '$stop!', '$start!', '$setup', '$every', '$update!', '$/', '$playing=', '$text', '$stop', '$private', '$update', '$render', '$ready?', '$setup!']);
  ;
  ;
  ;
  ;
  ...
  (function($base, $super) {
    ...
    (function($base, $super) {
      ...
      def.startButton = def.window = def.turns_per_second = def.game_loop = def.engine = def.menu = nil;
      def.$initialize = function() {
        var $a, $b, self = this;

        self.engine = (($a = ((($b = $scope.TheGame) == null ? $opal.cm('TheGame') : $b))._scope).Engine == null ? $a.cm('Engine') : $a.Engine).$new();
        self.menu = (($a = ((($b = $scope.TheGame) == null ? $opal.cm('TheGame') : $b))._scope).Menu == null ? $a.cm('Menu') : $a.Menu).$new();
      ...
      def['$setup!'] = function() {
        ...
        ($a = ($b = self.startButton).$on, $a._p = (TMP_1 = function(){var self = TMP_1._s || this, $a;
      ...
      def['$start!'] = function() {
        ...
        self.game_loop = ($a = ($b = self).$every, $a._p = (TMP_2 = function(){var self = TMP_2._s || this;

        return self['$update!']()}, TMP_2._s = self, TMP_2), $a).call($b, (1000)['$/'](self.turns_per_second));
        self.playing = true;
    ...
    return (def.$initialize = function() {
      ...
      return ($a = ($b = (($c = $scope.Document) == null ? $opal.cm('Document') : $c))['$ready?'], $a._p = (TMP_3 = function(){var self = TMP_3._s || this, $a;
        if (self.game_loop == null) self.game_loop = nil;

      self.game_loop = (($a = $scope.GameLoop) == null ? $opal.cm('GameLoop') : $a).$new();
        self.game_loop['$setup!']();
        return self.game_loop['$start!']();}, TMP_3._s = self, TMP_3), $a).call($b);
    }, nil) && 'initialize';
  })(self, null);
