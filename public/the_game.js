...
(function($opal) {
  ...
  $opal.add_stubs(['$include', '$attr_accessor', '$attr_reader', '$+', '$/', '$rand', '$do_stuff', '$new', '$nil?', '$[]', '$x=', '$y=', '$create', '$has?', '$get', '$hunger_per_minute_added', '$thirst_per_minute_added', '$!', '$==', '$raise', '$<', '$count', '$update_hunger', '$update_energy', '$update_thirst', '$perform', '$-', '$*', '$thirst', '$>', '$hunger', '$energy']);
  return (function($base, $super) {
    function $TheGame(){};
    var self = $TheGame = $klass($base, $super, 'TheGame', $TheGame);
    ...
    return (function($base, $super) {
      ...
      def['$can_carry_more?'] = function(item_type) {
        ...
        if ((($a = item_type['$==']("firewood")['$!']()) !== nil && (!$a._isBoolean || $a == true))) {
...
(function($opal) {
  ...
  $opal.add_stubs(['$thirsty?', '$action=', '$create', '$hungry?', '$sleepy?', '$will_take_jobs', '$get_job', '$instance', '$do_stuff']);
  return (function($base, $super) {
    function $TheGame(){};
    var self = $TheGame = $klass($base, $super, 'TheGame', $TheGame);
...
if (job_type == null) job_type = nil;
        if ((($a = ($b = (($c = job_type['$==']("survival")) ? self.fireplace['$fire_is_ok?']()['$!']() : $c), $b !== false && $b !== nil ?self.stash['$has?']("firewood") : $b)) !== nil && (!$a._isBoolean || $a == true))) {
            ...
            if ((($a = self['$needs_cleaning?']("haul")) !== nil && (!$a._isBoolean || $a == true))) {
              tile = self.dormitory.$tile_for_cleaning("haul");
              action = (($a = ((($b = $scope.Action) == null ? $opal.cm('Action') : $b))._scope).Supply == null ? $a.cm('Supply') : $a.Supply).$create(self.stash, $hash2(["with", "from"], {"with": "firewood", "from": tile.$content()}));
              $opal.$return(action);
