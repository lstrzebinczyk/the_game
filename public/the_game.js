...
(function($opal) {
  ...
  $opal.add_stubs(['$reset!', '$-', '$<', '$==']);
  return (function($base, $super) {
    function $Countdown(){};
    var self = $Countdown = $klass($base, $super, 'Countdown', $Countdown);

    var def = self._proto, $scope = self._scope;

    def.minutes_left = def.limit = nil;
    def.$initialize = function(limit) {
      var self = this;
    ...
    def.$add_minutes = function(minutes) {
      var self = this;

      self.minutes_left = self.minutes_left['$-'](minutes);
    ...
    def['$reset!'] = function() {
      ...
      return self.minutes_left = self.limit;
    };

    return (def.$to_i = function() {
      var self = this;
...
//# sourceMappingURL=/__opal_source_maps__/support/countdown.js.map
;
/* Generated by Opal 0.6.2 */
(function($opal) {
  var self = $opal.top, $scope = $opal, nil = $opal.nil, $breaker = $opal.breaker, $slice = $opal.slice, $klass = $opal.klass, $hash2 = $opal.hash2;

  $opal.add_stubs(['$attr_accessor', '$attr_reader', '$[]', '$find', '$each_tile', '$<', '$distance_to', '$<<', '$new', '$x', '$y', '$update', '$nil?', '$length', '$first', '$each', '$private']);
  return (function($base, $super) {
    function $TheGame(){};
    ...
    return (function($base, $super) {
      ...
      def.$fetch = TMP_1 = function(width, height) {
        var $a, self = this, $iter = TMP_1._p, $yield = $iter || nil, tile = nil;

        TMP_1._p = null;
        tile = ($a = self.grid['$[]'](width), $a !== false && $a !== nil ?self.grid['$[]'](width)['$[]'](height) : $a);
        if (($yield !== nil)) {
          if ($opal.$yield1($yield, tile) === $breaker) return $breaker.$v};
        return tile;
      };

      def.$find_closest_to = TMP_3 = function(person) {
        var $a, $b, TMP_2, $c, TMP_4, self = this, $iter = TMP_3._p, $yield = $iter || nil, closest = nil;

        TMP_3._p = null;
        closest = ($a = ($b = self).$find, $a._p = (TMP_2 = function(tile){var self = TMP_2._s || this, $a;
if (tile == null) tile = nil;
        return $a = $opal.$yield1($yield, tile), $a === $breaker ? $a : $a}, TMP_2._s = self, TMP_2), $a).call($b);
        if (closest !== false && closest !== nil) {
          ($a = ($c = self).$each_tile, $a._p = (TMP_4 = function(tile){var self = TMP_4._s || this, $a, $b;
if (tile == null) tile = nil;
          if ((($a = ((($b = $opal.$yield1($yield, tile)) === $breaker) ? $breaker.$v : $b)) !== nil && (!$a._isBoolean || $a == true))) {
      ...
      def.$create_building_event = function(building) {
        var $a, self = this;

        return self.events['$<<']((($a = $scope.Event) == null ? $opal.cm('Event') : $a).$new("building_created", building.$x(), building.$y(), $hash2(["building"], {"building": building})));
      };
...
if (tile == null) tile = nil;
      ...
      def.$each_tile = TMP_8 = function() {
        var $a, $b, TMP_6, self = this, $iter = TMP_8._p, $yield = $iter || nil;

        TMP_8._p = null;
        return ($a = ($b = self.grid).$each, $a._p = (TMP_6 = function(row){var self = TMP_6._s || this, $a, $b, TMP_7;
if (row == null) row = nil;
        return ($a = ($b = row).$each, $a._p = (TMP_7 = function(tile){var self = TMP_7._s || this, $a;
if (tile == null) tile = nil;
          return $a = $opal.$yield1($yield, tile), $a === $breaker ? $a : $a}, TMP_7._s = self, TMP_7), $a).call($b)}, TMP_6._s = self, TMP_6), $a).call($b);
      };

      self.$private();

      return (def.$find = TMP_10 = function() {try {

        var $a, $b, TMP_9, self = this, $iter = TMP_10._p, $yield = $iter || nil;

        TMP_10._p = null;
        ($a = ($b = self).$each_tile, $a._p = (TMP_9 = function(tile){var self = TMP_9._s || this, $a, $b;
if (tile == null) tile = nil;
        if ((($a = ((($b = $opal.$yield1($yield, tile)) === $breaker) ? $breaker.$v : $b)) !== nil && (!$a._isBoolean || $a == true))) {
            $opal.$return(tile)
            } else {
...
//# sourceMappingURL=/__opal_source_maps__/the_game/map.js.map
;
/* Generated by Opal 0.6.2 */
(function($opal) {
  var self = $opal.top, $scope = $opal, nil = $opal.nil, $breaker = $opal.breaker, $slice = $opal.slice, $klass = $opal.klass, $hash2 = $opal.hash2;

  $opal.add_stubs(['$each', '$[]=', '$count', '$<<', '$[]', '$type', '$pop', '$any?', '$size', '$inject', '$to_proc', '$map', '$amount', '$+', '$alphas']);
  return (function($base, $super) {
    function $TheGame(){};
    var self = $TheGame = $klass($base, $super, 'TheGame', $TheGame);
...
if (type == null) type = nil;
      ...
      def.$each = TMP_3 = function() {
        var $a, $b, TMP_2, $c, self = this, $iter = TMP_3._p, $yield = $iter || nil;

        TMP_3._p = null;
        return ($a = ($b = (($c = $scope.ITEM_TYPES) == null ? $opal.cm('ITEM_TYPES') : $c)).$each, $a._p = (TMP_2 = function(type){var self = TMP_2._s || this, $a;
if (type == null) type = nil;
        return $a = $opal.$yieldX($yield, [type, self.$count(type)]), $a === $breaker ? $a : $a}, TMP_2._s = self, TMP_2), $a).call($b);
      };

      def.$add = function(item) {
        var self = this;

        return self.content['$[]'](item.$type())['$<<'](item);
      };

      def.$get = function(type) {
        var self = this;

        return self.content['$[]'](type).$pop();
      };

      def['$has?'] = function(type) {
        var self = this;

        return self.content['$[]'](type)['$any?']();
      };

      def.$count = function(type) {
        var self = this;

        return self.content['$[]'](type).$size();
      };

      def.$firewood_amount = function() {
        var $a, $b, $c, $d, TMP_4, self = this;

        return ($a = ($b = ($c = ($d = self.content['$[]']("firewood")).$map, $c._p = (TMP_4 = function(wood){var self = TMP_4._s || this;
if (wood == null) wood = nil;
        return wood.$amount()}, TMP_4._s = self, TMP_4), $c).call($d)).$inject, $a._p = "+".$to_proc(), $a).call($b, 0);
      };

      return (def.$food_amount = function() {
        var $a, $b, $c, $d, TMP_5, $e, $f, TMP_6, self = this;

        return ($a = ($b = ($c = ($d = self.content['$[]']("berries")).$map, $c._p = (TMP_5 = function(food){var self = TMP_5._s || this;
if (food == null) food = nil;
        return food.$alphas()}, TMP_5._s = self, TMP_5), $c).call($d)).$inject, $a._p = "+".$to_proc(), $a).call($b, 0)['$+'](($a = ($c = ($e = ($f = self.content['$[]']("cooked_fish")).$map, $e._p = (TMP_6 = function(food){var self = TMP_6._s || this;
if (food == null) food = nil;
        return food.$alphas()}, TMP_6._s = self, TMP_6), $e).call($f)).$inject, $a._p = "+".$to_proc(), $a).call($c, 0));
      }, nil) && 'food_amount';
    })(self, null)
  })(self, null)
})(Opal);

//# sourceMappingURL=/__opal_source_maps__/the_game/container.js.map
;
/* Generated by Opal 0.6.2 */
(function($opal) {
  var self = $opal.top, $scope = $opal, nil = $opal.nil, $breaker = $opal.breaker, $slice = $opal.slice, $klass = $opal.klass, $module = $opal.module;
  ...
  return (function($base, $super) {
    ...
    return (function($base) {
      var self = $module($base, 'HasPosition');
      ...
      (function($base, $super) {
        ...
        return (def.$method_missing = TMP_1 = function(meth, args) {
          var $a, $b, self = this, $iter = TMP_1._p, block = $iter || nil;

          args = $slice.call(arguments, 1);
          TMP_1._p = null;
          return ($a = ($b = self.parent).$send, $a._p = block.$to_proc(), $a).apply($b, [meth].concat(args));
        }, nil) && 'method_missing';
      })(self, null);
      ...
      def.$close_enough_to = function(object) {
        ...
        return self.$distance_to(object)['$<'](2.0);
      };

      def.$distance_to = function(object) {
        var $a, self = this;

        return (($a = $scope.Math) == null ? $opal.cm('Math') : $a).$sqrt((self.$x()['$-'](object.$x()))['$**'](2)['$+']((self.$y()['$-'](object.$y()))['$**'](2)));
      };

      def.$position = function(x, y, parent) {
        var $a, self = this;

        return (($a = $scope.Position) == null ? $opal.cm('Position') : $a).$new(x, y, parent);
      };

      def.$go_to = function(object) {
        var $a, self = this;

        if (object.$x()['$<'](self.$x())) {
          ($a = self, $a['$x=']($a.$x()['$-'](1)))
        } else if (object.$x()['$>'](self.$x())) {
          ($a = self, $a['$x=']($a.$x()['$+'](1)))};
        if (object.$y()['$<'](self.$y())) {
          return ($a = self, $a['$y=']($a.$y()['$-'](1)))
        } else if (object.$y()['$>'](self.$y())) {
          return ($a = self, $a['$y=']($a.$y()['$+'](1)))
          } else {
          return nil
        };
...
//# sourceMappingURL=/__opal_source_maps__/the_game/has_position.js.map
;
/* Generated by Opal 0.6.2 */
(function($opal) {
  var self = $opal.top, $scope = $opal, nil = $opal.nil, $breaker = $opal.breaker, $slice = $opal.slice, $klass = $opal.klass;
  ...
  return (function($base, $super) {
    ...
    return (function($base, $super) {
      ...
      var self = $Construction = $klass($base, $super, 'Construction', $Construction);

      var def = self._proto, $scope = self._scope, $a;

      return (function($base, $super) {
        function $Stash(){};
        var self = $Stash = $klass($base, $super, 'Stash', $Stash);

        var def = self._proto, $scope = self._scope, $a, TMP_1;

        self.$include((($a = $scope.HasPosition) == null ? $opal.cm('HasPosition') : $a));

        def.$initialize = TMP_1 = function(x, y) {
          var self = this, $iter = TMP_1._p, $yield = $iter || nil;

          TMP_1._p = null;
          self.x = x;
          self.y = y;
          return $opal.find_super_dispatcher(self, 'initialize', TMP_1, null).apply(self, []);
        };
...
//# sourceMappingURL=/__opal_source_maps__/the_game/construction/stash.js.map
;
/* Generated by Opal 0.6.2 */
(function($opal) {
  var self = $opal.top, $scope = $opal, nil = $opal.nil, $breaker = $opal.breaker, $slice = $opal.slice, $klass = $opal.klass;
  ...
  return (function($base, $super) {
    ...
    return (function($base, $super) {
      ...
      return (function($base, $super) {
        function $Dormitory(){};
        var self = $Dormitory = $klass($base, $super, 'Dormitory', $Dormitory);

        var def = self._proto, $scope = self._scope, $a;

        def.status = def.firewood_needed = nil;
        self.$include((($a = $scope.HasPosition) == null ? $opal.cm('HasPosition') : $a));

        self.$attr_reader("firewood_needed");

        self.$attr_accessor("minutes_left", "status", "fields");
        ...
        def.$initialize = function(x, y) {
          ...
          return self.firewood_needed = 60;
        };
        ...
        def.$description = function() {
          ...
          if ((($a = ((($b = self.status['$==']("plan")) !== false && $b !== nil) ? $b : self.status['$==']("building"))) !== nil && (!$a._isBoolean || $a == true))) {
            return "Dormitory construction"
            } else {
            return "Dormitory"
          };
        };

        def['$terrain_clear?'] = function() {
          var $a, $b, self = this;

          return ($a = ($b = self.$fields())['$all?'], $a._p = "empty?".$to_proc(), $a).call($b);
        };

        def['$can_start_building?'] = function() {
          var $a, self = this;

          return ($a = self['$terrain_clear?'](), $a !== false && $a !== nil ?self.status['$==']("cleaning") : $a);
        };

        def['$start_building!'] = function() {
          var self = this;

          return self.status = "plan";
        };

        def.$tile_for_cleaning = function(job_type) {
          var $a, $b, TMP_1, $c, TMP_2, $d, TMP_3, self = this;

          if (job_type['$==']("gatherer")) {
            return ($a = ($b = self.$fields()).$find, $a._p = (TMP_1 = function(tile){var self = TMP_1._s || this, $a, $b;
if (tile == null) tile = nil;
...
if (tile == null) tile = nil;
            return tile.$content()['$is_a?']((($a = ((($b = $scope.Nature) == null ? $opal.cm('Nature') : $b))._scope).LogPile == null ? $a.cm('LogPile') : $a.LogPile))}, TMP_3._s = self, TMP_3), $a).call($d)
            } else {
            return nil
          };
        };

        def['$needs_cleaning?'] = function(job_type) {
          var $a, $b, TMP_4, $c, TMP_5, $d, TMP_6, self = this;

          if (job_type['$==']("gatherer")) {
            return ($a = ($b = self.$fields())['$any?'], $a._p = (TMP_4 = function(tile){var self = TMP_4._s || this, $a, $b;
if (tile == null) tile = nil;
...
if (tile == null) tile = nil;
            return tile.$content()['$is_a?']((($a = ((($b = $scope.Nature) == null ? $opal.cm('Nature') : $b))._scope).LogPile == null ? $a.cm('LogPile') : $a.LogPile))}, TMP_6._s = self, TMP_6), $a).call($d)
            } else {
            return nil
          };
        };

        def['$need_wood?'] = function() {
          var self = this;

          return self.firewood_needed['$>'](0);
        };
        ...
        def['$need?'] = function(item_type) {
          ...
          if (item_type['$==']("firewood")) {
            return self['$need_wood?']()
            } else {
            return nil
          };
        };

        def.$sleep_area = function() {
          var self = this;
        ...
        def['$ready_to_build?'] = function() {
          var $a, self = this;

          return (($a = self.firewood_needed['$=='](0)) ? self.status['$==']("building") : $a);
        };
        ...
        def.$add = function(item) {
          ...
          if (item.$type()['$==']("firewood")) {
            self.firewood_needed = self.firewood_needed['$-'](1);
            if (self.firewood_needed['$=='](0)) {
...
//# sourceMappingURL=/__opal_source_maps__/the_game/construction/dormitory.js.map
;
/* Generated by Opal 0.6.2 */
(function($opal) {
  var self = $opal.top, $scope = $opal, nil = $opal.nil, $breaker = $opal.breaker, $slice = $opal.slice, $klass = $opal.klass;

  $opal.add_stubs(['$include', '$new', '$*', '$sample', '$==', '$position', '$+', '$x', '$y', '$add_minutes', '$to_i', '$-@', '$amount', '$>']);
  return (function($base, $super) {
    function $TheGame(){};
    var self = $TheGame = $klass($base, $super, 'TheGame', $TheGame);
    ...
    return (function($base, $super) {
      ...
      return (function($base, $super) {
        function $Fireplace(){};
        var self = $Fireplace = $klass($base, $super, 'Fireplace', $Fireplace);

        var def = self._proto, $scope = self._scope, $a;

        def.minutes_left_for_fire = nil;
        self.$include((($a = $scope.HasPosition) == null ? $opal.cm('HasPosition') : $a));
        ...
        def.$initialize = function(x, y) {
          ...
          self.x = x;
          self.y = y;
          return self.minutes_left_for_fire = (($a = $scope.Countdown) == null ? $opal.cm('Countdown') : $a).$new((4)['$*'](60));
        };

        def.$sleep_area = function() {
          var $a, $b, $c, self = this, x_offset = nil, y_offset = nil;

          x_offset = [-2, -1, 0, 1, 2].$sample();
          y_offset = [-2, -1, 0, 1, 2].$sample();
          while ((($b = ((($c = x_offset['$=='](0)) ? y_offset['$=='](0) : $c))) !== nil && (!$b._isBoolean || $b == true))) {
          x_offset = [-2, -1, 0, 1, 2].$sample();
          y_offset = [-2, -1, 0, 1, 2].$sample();};
          return self.$position(self.$x()['$+'](x_offset), self.$y()['$+'](y_offset), self);
        };

        def.$update = function(minutes) {
          var self = this;

          return self.minutes_left_for_fire.$add_minutes(minutes);
        };

        def.$minutes_left_for_fire = function() {
          var self = this;

          return self.minutes_left_for_fire.$to_i();
        };

        def.$add_firewood_to_fire = function(firewood) {
          var self = this;

          return self.minutes_left_for_fire.$add_minutes(firewood.$amount()['$-@']());
        };

        def['$fire_is_ok?'] = function() {
          var self = this;

          return self.minutes_left_for_fire.$to_i()['$>']((4)['$*'](60));
        };
...
//# sourceMappingURL=/__opal_source_maps__/the_game/construction/fireplace.js.map
;
/* Generated by Opal 0.6.2 */
(function($opal) {
  var self = $opal.top, $scope = $opal, nil = $opal.nil, $breaker = $opal.breaker, $slice = $opal.slice, $klass = $opal.klass, $hash2 = $opal.hash2;

  $opal.add_stubs(['$empty?', '$instance', '$action=', '$create', '$stash', '$content']);
  return (function($base, $super) {
    function $TheGame(){};
    var self = $TheGame = $klass($base, $super, 'TheGame', $TheGame);
    ...
    return (function($base, $super) {
      ...
      return (function($base, $super) {
        function $Woodcutter(){};
        var self = $Woodcutter = $klass($base, $super, 'Woodcutter', $Woodcutter);

        var def = self._proto, $scope = self._scope;

        def.recently_cut_tree_at = nil;
        def.$type = function() {
          var self = this;
        ...
        def.$accepted_jobs = function() {
          var self = this;

          return ["woodcutting", "haul"];
        };

        def['$recently_cut_tree_at='] = function(tree_tile) {
          var self = this;

          return self.recently_cut_tree_at = tree_tile;
        };

        def['$has_personal_jobs?'] = function() {
          var $a, $b, self = this;

          if ((($a = ($b = self.recently_cut_tree_at, $b !== false && $b !== nil ?self.recently_cut_tree_at['$empty?']() : $b)) !== nil && (!$a._isBoolean || $a == true))) {
            return self.recently_cut_tree_at = nil
            } else {
            return self.recently_cut_tree_at
          };
        };

        return (def.$take_personal_job = function() {
          var $a, $b, self = this, settlement = nil;

          settlement = (($a = $scope.Settlement) == null ? $opal.cm('Settlement') : $a).$instance();
          return self['$action=']((($a = ((($b = $scope.Action) == null ? $opal.cm('Action') : $b))._scope).Supply == null ? $a.cm('Supply') : $a.Supply).$create(settlement.$stash(), $hash2(["with", "from"], {"with": "log", "from": self.recently_cut_tree_at.$content()})));
        }, nil) && 'take_personal_job';
      })(self, (($a = $scope.Person) == null ? $opal.cm('Person') : $a))
    })(self, null)
  })(self, null)
})(Opal);

//# sourceMappingURL=/__opal_source_maps__/the_game/person/woodcutter.js.map
;
/* Generated by Opal 0.6.2 */
(function($opal) {
  var self = $opal.top, $scope = $opal, nil = $opal.nil, $breaker = $opal.breaker, $slice = $opal.slice, $klass = $opal.klass;
  ...
  return (function($base, $super) {
    ...
    return (function($base, $super) {
      ...
      return (function($base, $super) {
        function $Gatherer(){};
        var self = $Gatherer = $klass($base, $super, 'Gatherer', $Gatherer);
        ...
        return (def.$accepted_jobs = function() {
          var self = this;

          return ["gatherer", "haul"];
        }, nil) && 'accepted_jobs';
      })(self, (($a = $scope.Person) == null ? $opal.cm('Person') : $a))
    })(self, null)
  })(self, null)
...
//# sourceMappingURL=/__opal_source_maps__/the_game/person/gatherer.js.map
;
/* Generated by Opal 0.6.2 */
(function($opal) {
  var self = $opal.top, $scope = $opal, nil = $opal.nil, $breaker = $opal.breaker, $slice = $opal.slice, $klass = $opal.klass;
  ...
  return (function($base, $super) {
    ...
    return (function($base, $super) {
      ...
      return (function($base, $super) {
        function $Fisherman(){};
        var self = $Fisherman = $klass($base, $super, 'Fisherman', $Fisherman);
...
//# sourceMappingURL=/__opal_source_maps__/the_game/person/fisherman.js.map
;
/* Generated by Opal 0.6.2 */
(function($opal) {
  var self = $opal.top, $scope = $opal, nil = $opal.nil, $breaker = $opal.breaker, $slice = $opal.slice, $klass = $opal.klass;
  ...
  return (function($base, $super) {
    ...
    return (function($base, $super) {
      ...
      return (function($base, $super) {
        function $Leader(){};
        var self = $Leader = $klass($base, $super, 'Leader', $Leader);
        ...
        return (def.$accepted_jobs = function() {
          ...
          return ["management", "survival", "building", "haul"];
        }, nil) && 'accepted_jobs';
      })(self, (($a = $scope.Person) == null ? $opal.cm('Person') : $a))
    })(self, null)
  })(self, null)
...
//# sourceMappingURL=/__opal_source_maps__/the_game/person/leader.js.map
;
/* Generated by Opal 0.6.2 */
(function($opal) {
  var self = $opal.top, $scope = $opal, nil = $opal.nil, $breaker = $opal.breaker, $slice = $opal.slice, $klass = $opal.klass;
  ...
  return (function($base, $super) {
    ...
    return (function($base, $super) {
      ...
      return (function($base, $super) {
        function $Axe(){};
        var self = $Axe = $klass($base, $super, 'Axe', $Axe);
...
//# sourceMappingURL=/__opal_source_maps__/the_game/item/axe.js.map
;
/* Generated by Opal 0.6.2 */
(function($opal) {
  var self = $opal.top, $scope = $opal, nil = $opal.nil, $breaker = $opal.breaker, $slice = $opal.slice, $klass = $opal.klass;
  ...
  return (function($base, $super) {
    ...
    return (function($base, $super) {
      ...
      return (function($base, $super) {
        function $Fish(){};
        var self = $Fish = $klass($base, $super, 'Fish', $Fish);
...
//# sourceMappingURL=/__opal_source_maps__/the_game/item/fish.js.map
;
/* Generated by Opal 0.6.2 */
(function($opal) {
  var self = $opal.top, $scope = $opal, nil = $opal.nil, $breaker = $opal.breaker, $slice = $opal.slice, $klass = $opal.klass;

  $opal.add_stubs(['$/', '$*', '$minutes_to_eat', '$hunger_per_minute_added']);
  return (function($base, $super) {
    function $TheGame(){};
    var self = $TheGame = $klass($base, $super, 'TheGame', $TheGame);
    ...
    return (function($base, $super) {
      ...
      return (function($base, $super) {
        function $CookedFish(){};
        var self = $CookedFish = $klass($base, $super, 'CookedFish', $CookedFish);

        var def = self._proto, $scope = self._scope;

        def.$minutes_to_eat = function() {
          var self = this;

          return 20;
        };

        def.$hunger_per_minute_added = function() {
          var self = this;
        ...
        def.$alphas = function() {
          ...
          return self.$minutes_to_eat()['$*'](self.$hunger_per_minute_added());
        };
...
//# sourceMappingURL=/__opal_source_maps__/the_game/item/cooked_fish.js.map
;
/* Generated by Opal 0.6.2 */
(function($opal) {
  var self = $opal.top, $scope = $opal, nil = $opal.nil, $breaker = $opal.breaker, $slice = $opal.slice, $klass = $opal.klass;
  ...
  return (function($base, $super) {
    ...
    return (function($base, $super) {
      ...
      return (function($base, $super) {
        function $FishingRod(){};
        var self = $FishingRod = $klass($base, $super, 'FishingRod', $FishingRod);
...
//# sourceMappingURL=/__opal_source_maps__/the_game/item/fishing_rod.js.map
;
/* Generated by Opal 0.6.2 */
(function($opal) {
  var self = $opal.top, $scope = $opal, nil = $opal.nil, $breaker = $opal.breaker, $slice = $opal.slice, $klass = $opal.klass;
  ...
  return (function($base, $super) {
    ...
    return (function($base, $super) {
      ...
      return (function($base, $super) {
        function $Firewood(){};
        var self = $Firewood = $klass($base, $super, 'Firewood', $Firewood);
...
//# sourceMappingURL=/__opal_source_maps__/the_game/item/firewood.js.map
;
/* Generated by Opal 0.6.2 */
(function($opal) {
  var self = $opal.top, $scope = $opal, nil = $opal.nil, $breaker = $opal.breaker, $slice = $opal.slice, $klass = $opal.klass;
  ...
  return (function($base, $super) {
    ...
    return (function($base, $super) {
      ...
      return (function($base, $super) {
        function $Berries(){};
        var self = $Berries = $klass($base, $super, 'Berries', $Berries);
        ...
        def.$hunger_per_minute_added = function() {
          ...
          return (0.2)['$/'](self.$minutes_to_eat());
        };
...
//# sourceMappingURL=/__opal_source_maps__/the_game/item/berries.js.map
;
/* Generated by Opal 0.6.2 */
(function($opal) {
  var self = $opal.top, $scope = $opal, nil = $opal.nil, $breaker = $opal.breaker, $slice = $opal.slice, $klass = $opal.klass;
...
(function($opal) {
  ...
  return (function($base, $super) {
    ...
    return (function($base, $super) {
      ...
      return (function($base, $super) {
        function $Water(){};
        var self = $Water = $klass($base, $super, 'Water', $Water);
...
//# sourceMappingURL=/__opal_source_maps__/the_game/item/water.js.map
;
/* Generated by Opal 0.6.2 */
(function($opal) {
  var self = $opal.top, $scope = $opal, nil = $opal.nil, $breaker = $opal.breaker, $slice = $opal.slice, $klass = $opal.klass;

  $opal.add_stubs(['$times', '$<<', '$new', '$capacity', '$/', '$units', '$pop', '$any?', '$size', '$==']);
  return (function($base, $super) {
    function $TheGame(){};
    var self = $TheGame = $klass($base, $super, 'TheGame', $TheGame);
    ...
    return (function($base, $super) {
      ...
      return (function($base, $super) {
        function $Waterskin(){};
        var self = $Waterskin = $klass($base, $super, 'Waterskin', $Waterskin);
        ...
        def.$initialize = function() {
          ...
          self.content = [];
          return ($a = ($b = self.$capacity()).$times, $a._p = (TMP_1 = function(){var self = TMP_1._s || this, $a;
            if (self.content == null) self.content = nil;

          return self.content['$<<']((($a = $scope.Water) == null ? $opal.cm('Water') : $a).$new())}, TMP_1._s = self, TMP_1), $a).call($b);
        };

        def.$fill_with = function(item) {
          var self = this;
...
//# sourceMappingURL=/__opal_source_maps__/the_game/item/waterskin.js.map
;
/* Generated by Opal 0.6.2 */
(function($opal) {
  var self = $opal.top, $scope = $opal, nil = $opal.nil, $breaker = $opal.breaker, $slice = $opal.slice, $klass = $opal.klass;
...
//# sourceMappingURL=/__opal_source_maps__/the_game/map/generator.js.map
;
/* Generated by Opal 0.6.2 */
(function($opal) {
  var self = $opal.top, $scope = $opal, nil = $opal.nil, $breaker = $opal.breaker, $slice = $opal.slice, $klass = $opal.klass;
  ...
  return (function($base, $super) {
    ...
    return (function($base, $super) {
      ...
      return (function($base, $super) {
        function $Tile(){};
        var self = $Tile = $klass($base, $super, 'Tile', $Tile);

        var def = self._proto, $scope = self._scope, $a, $b;

        def.building = def.content = def.terrain = def.x = def.y = nil;
        (function($base, $super) {
        ...
        def.$update = function() {
          ...
          if ((($a = self.content['$empty?']()) !== nil && (!$a._isBoolean || $a == true))) {
            ...
            return self.$clean_event(self.x, self.y);}else if ("tree"['$===']($case)) {self.content = (($a = ((($b = $scope.Nature) == null ? $opal.cm('Nature') : $b))._scope).LogPile == null ? $a.cm('LogPile') : $a.LogPile).$new(self.x, self.y);
            return self.$update_event(self.x, self.y);}else if ("log_pile"['$===']($case)) {self['$clean!']();
        ...
        def.$clean_event = function(x, y) {
          var $a, $b, self = this;

          return (($a = ((($b = $scope.Map) == null ? $opal.cm('Map') : $b))._scope).Event == null ? $a.cm('Event') : $a.Event).$new("clean", x, y);
        };

        return (def.$update_event = function(x, y) {
          var $a, $b, self = this;

          return (($a = ((($b = $scope.Map) == null ? $opal.cm('Map') : $b))._scope).Event == null ? $a.cm('Event') : $a.Event).$new("update", x, y);
        }, nil) && 'update_event';
      })(self, null)
    })(self, null)
  })(self, null)
  ...
  return (function($base, $super) {
    ...
    return (function($base, $super) {
      ...
      return (function($base, $super) {
        ...
        return (def.$initialize = function(type, x, y, opts) {
          var self = this;
...
(function($opal) {
  ...
  $opal.add_stubs(['$attr_reader', '$is_a?', '$each', '$<<', '$actions', '$first', '$perform', '$done?', '$shift', '$empty?', '$do_stuff', '$description', '$raise', '$new', '$private_class_method', '$then', '$class']);
  return (function($base, $super) {
    function $TheGame(){};
    var self = $TheGame = $klass($base, $super, 'TheGame', $TheGame);
    ...
    return (function($base, $super) {
      ...
      (function($base, $super) {
        ...
        def.actions = def.description = nil;
        self.$attr_reader("actions");
        ...
        def.$then = function(next_action) {
          var $a, $b, TMP_1, self = this;

          if ((($a = next_action['$is_a?']((($b = $scope.Chain) == null ? $opal.cm('Chain') : $b))) !== nil && (!$a._isBoolean || $a == true))) {
            ($a = ($b = next_action.$actions()).$each, $a._p = (TMP_1 = function(action){var self = TMP_1._s || this;
              if (self.actions == null) self.actions = nil;
if (action == null) action = nil;
            return self.actions['$<<'](action)}, TMP_1._s = self, TMP_1), $a).call($b)
            } else {
        ...
        def.$perform = function(person, map, time_in_minutes) {
          var $a, self = this, action = nil;

          action = self.actions.$first();
          action.$perform(person, map, time_in_minutes);
          if ((($a = action['$done?'](person)) !== nil && (!$a._isBoolean || $a == true))) {
            self.actions.$shift();
            if ((($a = self.actions['$empty?']()) !== nil && (!$a._isBoolean || $a == true))) {
        ...
        def['$description='] = function(description) {
          var self = this;
        ...
        def.$description = function() {
          ...
          return ((($a = self.description) !== false && $a !== nil) ? $a : self.actions.$first().$description());
        };

        return (def['$done?'] = function(person) {
          var self = this;

          return self.$raise("#done? called on action chain");
        }, nil) && 'done?';
      })(self, null);

      $opal.defs(self, '$create', function(params) {
        var $a, self = this;

        params = $slice.call(arguments, 0);
        return ($a = self).$new.apply($a, [].concat(params));
      });
      ...
      def.$then = function(action) {
        ...
        return (($a = $scope.Chain) == null ? $opal.cm('Chain') : $a).$new(self).$then(action);
      };
      ...
      return (def['$done?'] = function(person) {
        ...
        return self.$raise("" + (self.$class()) + "#done? not implemented");
      }, nil) && 'done?';
    })(self, null)
  })(self, null)
})(Opal);

//# sourceMappingURL=/__opal_source_maps__/the_game/action.js.map
;
/* Generated by Opal 0.6.2 */
(function($opal) {
  var self = $opal.top, $scope = $opal, nil = $opal.nil, $breaker = $opal.breaker, $slice = $opal.slice, $klass = $opal.klass;
...
//# sourceMappingURL=/__opal_source_maps__/the_game/item.js.map
;
/* Generated by Opal 0.6.2 */
(function($opal) {
  var self = $opal.top, $scope = $opal, nil = $opal.nil, $breaker = $opal.breaker, $slice = $opal.slice, $klass = $opal.klass, $hash2 = $opal.hash2;

  $opal.add_stubs(['$include', '$attr_accessor', '$attr_reader', '$+', '$/', '$rand', '$do_stuff', '$new', '$nil?', '$[]', '$x=', '$y=', '$create', '$has?', '$get', '$hunger_per_minute_added', '$thirst_per_minute_added', '$==', '$<', '$count', '$raise', '$update_hunger', '$update_energy', '$update_thirst', '$perform', '$-', '$*', '$thirst', '$>', '$hunger', '$energy']);
  return (function($base, $super) {
    function $TheGame(){};
    var self = $TheGame = $klass($base, $super, 'TheGame', $TheGame);
    ...
    return (function($base, $super) {
      ...
      def.inventory = def.hunger = def.thirst = def.action = def.dead = def.energy = nil;
      self.$include((($a = ((($b = $scope.TheGame) == null ? $opal.cm('TheGame') : $b))._scope).HasPosition == null ? $a.cm('HasPosition') : $a.HasPosition));

      self.$attr_accessor("action", "thirst", "hunger", "energy", "will_take_jobs");

      self.$attr_reader("inventory", "waterskin");

      def.$initialize = function(attrs) {
        var $a, $b, self = this;

        if (attrs == null) {
          attrs = $hash2([], {})
        }
        self.hunger = (0.8)['$+'](self.$rand()['$/'](10));
        self.energy = (0.3)['$+'](self.$rand()['$/'](2));
        self.thirst = (0.8)['$+'](self.$rand()['$/'](10));
        self.$do_stuff();
        self.inventory = (($a = $scope.Container) == null ? $opal.cm('Container') : $a).$new();
        self.waterskin = (($a = ((($b = $scope.Item) == null ? $opal.cm('Item') : $b))._scope).Waterskin == null ? $a.cm('Waterskin') : $a.Waterskin).$new();
        if ((($a = attrs['$[]']("will_take_jobs")['$nil?']()) !== nil && (!$a._isBoolean || $a == true))) {
          self.will_take_jobs = true
          } else {
          self.will_take_jobs = attrs['$[]']("will_take_jobs")
        };
        self['$x='](attrs['$[]']("x"));
        return self['$y='](attrs['$[]']("y"));
      };

      def.$do_stuff = function() {
        var $a, $b, self = this;

        return self.action = (($a = ((($b = $scope.Action) == null ? $opal.cm('Action') : $b))._scope).WonderForNoReason == null ? $a.cm('WonderForNoReason') : $a.WonderForNoReason).$create();
      };

      def['$has?'] = function(type) {
        var self = this;

        return self.inventory['$has?'](type);
      };

      def.$get = function(type) {
        var self = this;

        return self.inventory.$get(type);
      };

      def.$eat = function(food) {
        var self = this;

        return self.hunger = self.hunger['$+'](food.$hunger_per_minute_added());
      };

      def.$drink = function(food) {
        var self = this;

        return self.thirst = self.thirst['$+'](food.$thirst_per_minute_added());
      };

      def['$can_carry_more?'] = function(item_type) {
        var self = this;

        if (item_type['$==']("firewood")) {
          return self.inventory.$count(item_type)['$<'](5)
        } else if (item_type['$==']("log")) {
          return self.inventory.$count(item_type)['$<'](1)
          } else {
          return self.$raise("I wasn't expecting that")
        };
      };
      ...
      def.$update = function(map, time_in_minutes) {
        var self = this;

        self.$update_hunger(time_in_minutes);
        self.$update_energy(time_in_minutes);
        self.$update_thirst(time_in_minutes);
        return self.action.$perform(self, map, time_in_minutes);
      };

      def['$should_die?'] = function() {
        var self = this;
      ...
      def.$update_hunger = function(minutes) {
        var self = this;

        self.hunger = self.hunger['$-'](minutes['$/'](((24.0)['$*'](60))));
        if (self.hunger['$<'](0)) {
      ...
      def.$update_energy = function(minutes) {
        var self = this;

        self.energy = self.energy['$-'](minutes['$/'](960.0));
        if (self.energy['$<'](0)) {
...
//# sourceMappingURL=/__opal_source_maps__/the_game/person.js.map
;
/* Generated by Opal 0.6.2 */
(function($opal) {
  var self = $opal.top, $scope = $opal, nil = $opal.nil, $breaker = $opal.breaker, $slice = $opal.slice, $klass = $opal.klass;

  $opal.add_stubs(['$fireplace', '$instance', '$then', '$create', '$new', '$fire_is_ok?', '$get', '$stash', '$add_firewood_to_fire', '$do_stuff']);
  return (function($base, $super) {
    function $TheGame(){};
    var self = $TheGame = $klass($base, $super, 'TheGame', $TheGame);
    ...
    return (function($base, $super) {
      ...
      return (function($base, $super) {
        ...
        var self = $CheckFireplace = $klass($base, $super, 'CheckFireplace', $CheckFireplace);

        var def = self._proto, $scope = self._scope;

        def.fireplace = nil;
        $opal.defs(self, '$create', function() {
          var $a, $b, self = this, fireplace = nil;

          fireplace = (($a = ((($b = $scope.TheGame) == null ? $opal.cm('TheGame') : $b))._scope).Settlement == null ? $a.cm('Settlement') : $a.Settlement).$instance().$fireplace();
          return (($a = $scope.GoTo) == null ? $opal.cm('GoTo') : $a).$create(fireplace).$then(self.$new(fireplace));
        });

        def.$initialize = function(fireplace) {
          var self = this;

          return self.fireplace = fireplace;
        };

        def.$description = function() {
          var self = this;

          return "checking fireplace";
        };
        ...
        def['$done?'] = function(person) {
          ...
          return self.fireplace['$fire_is_ok?']();
        };

        return (def.$perform = function(person, map, time_in_minutes) {
          var $a, $b, self = this, settlement = nil, firewood = nil;

          settlement = (($a = ((($b = $scope.TheGame) == null ? $opal.cm('TheGame') : $b))._scope).Settlement == null ? $a.cm('Settlement') : $a.Settlement).$instance();
          firewood = settlement.$stash().$get("firewood");
          if (firewood !== false && firewood !== nil) {
            return self.fireplace.$add_firewood_to_fire(firewood)
            } else {
            return person.$do_stuff()
          };
        }, nil) && 'perform';
...
//# sourceMappingURL=/__opal_source_maps__/the_game/action/check_fireplace.js.map
;
/* Generated by Opal 0.6.2 */
(function($opal) {
  var self = $opal.top, $scope = $opal, nil = $opal.nil, $breaker = $opal.breaker, $slice = $opal.slice, $klass = $opal.klass;

  $opal.add_stubs(['$done_drinking?', '$drink', '$new']);
  return (function($base, $super) {
    function $TheGame(){};
    var self = $TheGame = $klass($base, $super, 'TheGame', $TheGame);
    ...
    return (function($base, $super) {
      ...
      return (function($base, $super) {
        function $DrinkFromRiver(){};
        var self = $DrinkFromRiver = $klass($base, $super, 'DrinkFromRiver', $DrinkFromRiver);
        ...
        def.$description = function() {
          ...
          return "drinking water from river";
        };

        def['$done?'] = function(person) {
          var self = this;

          return person['$done_drinking?']();
        };

        return (def.$perform = function(person, map, time_in_minutes) {
          var $a, $b, self = this;

          return person.$drink((($a = ((($b = $scope.Item) == null ? $opal.cm('Item') : $b))._scope).Water == null ? $a.cm('Water') : $a.Water).$new());
        }, nil) && 'perform';
      })(self, (($a = $scope.Action) == null ? $opal.cm('Action') : $a))
    })(self, null)
  })(self, null)
...
//# sourceMappingURL=/__opal_source_maps__/the_game/action/drink_from_river.js.map
;
/* Generated by Opal 0.6.2 */
(function($opal) {
  var self = $opal.top, $scope = $opal, nil = $opal.nil, $breaker = $opal.breaker, $slice = $opal.slice, $klass = $opal.klass, $hash2 = $opal.hash2;

  $opal.add_stubs(['$stash', '$instance', '$then', '$create', '$new', '$find_closest_to', '$==', '$terrain', '$action=']);
  return (function($base, $super) {
    function $TheGame(){};
    var self = $TheGame = $klass($base, $super, 'TheGame', $TheGame);
    ...
    return (function($base, $super) {
      ...
      return (function($base, $super) {
        function $GoFishing(){};
        var self = $GoFishing = $klass($base, $super, 'GoFishing', $GoFishing);

        var def = self._proto, $scope = self._scope;

        $opal.defs(self, '$create', function() {
          var $a, $b, self = this, stash = nil;

          stash = (($a = ((($b = $scope.TheGame) == null ? $opal.cm('TheGame') : $b))._scope).Settlement == null ? $a.cm('Settlement') : $a.Settlement).$instance().$stash();
          return (($a = ((($b = $scope.Action) == null ? $opal.cm('Action') : $b))._scope).Get == null ? $a.cm('Get') : $a.Get).$create("fishing_rod", $hash2(["from"], {"from": stash})).$then(self.$new());
        });

        def.$description = function() {
          var self = this;

          return "going fishing";
        };
        ...
        return (def.$perform = function(person, map, time_in_minutes) {
          ...
          closest = ($a = ($b = map).$find_closest_to, $a._p = (TMP_1 = function(tile){var self = TMP_1._s || this;
if (tile == null) tile = nil;
          return tile.$terrain()['$==']("river")}, TMP_1._s = self, TMP_1), $a).call($b, person);
          return person['$action=']((($a = ((($c = $scope.Action) == null ? $opal.cm('Action') : $c))._scope).GoTo == null ? $a.cm('GoTo') : $a.GoTo).$create(closest).$then((($a = ((($c = $scope.Action) == null ? $opal.cm('Action') : $c))._scope).CatchFish == null ? $a.cm('CatchFish') : $a.CatchFish).$create()));
        }, nil) && 'perform';
      })(self, null)
    })(self, null)
  })(self, null)
...
//# sourceMappingURL=/__opal_source_maps__/the_game/action/go_fishing.js.map
;
/* Generated by Opal 0.6.2 */
(function($opal) {
  var self = $opal.top, $scope = $opal, nil = $opal.nil, $breaker = $opal.breaker, $slice = $opal.slice, $klass = $opal.klass;

  $opal.add_stubs(['$thirsty?', '$action=', '$create', '$hungry?', '$sleepy?', '$has_personal_jobs?', '$take_personal_job', '$will_take_jobs', '$get_job', '$instance', '$do_stuff']);
  return (function($base, $super) {
    function $TheGame(){};
    var self = $TheGame = $klass($base, $super, 'TheGame', $TheGame);
    ...
    return (function($base, $super) {
      ...
      return (function($base, $super) {
        function $WonderForNoReason(){};
        var self = $WonderForNoReason = $klass($base, $super, 'WonderForNoReason', $WonderForNoReason);
        ...
        return (def.$perform = function(person, map, time_in_minutes) {
          var $a, $b, self = this, job = nil;

          if ((($a = person['$thirsty?']()) !== nil && (!$a._isBoolean || $a == true))) {
            return person['$action=']((($a = ((($b = $scope.Action) == null ? $opal.cm('Action') : $b))._scope).LookForSomethingToDrink == null ? $a.cm('LookForSomethingToDrink') : $a.LookForSomethingToDrink).$create())
          } else if ((($a = person['$hungry?']()) !== nil && (!$a._isBoolean || $a == true))) {
            return person['$action=']((($a = ((($b = $scope.Action) == null ? $opal.cm('Action') : $b))._scope).LookForFood == null ? $a.cm('LookForFood') : $a.LookForFood).$create())
          } else if ((($a = person['$sleepy?']()) !== nil && (!$a._isBoolean || $a == true))) {
            return person['$action=']((($a = ((($b = $scope.Action) == null ? $opal.cm('Action') : $b))._scope).LookForPlaceToSleep == null ? $a.cm('LookForPlaceToSleep') : $a.LookForPlaceToSleep).$create())
          } else if ((($a = person['$has_personal_jobs?']()) !== nil && (!$a._isBoolean || $a == true))) {
            return person.$take_personal_job()
          } else if ((($a = person.$will_take_jobs()) !== nil && (!$a._isBoolean || $a == true))) {
            job = (($a = ((($b = $scope.TheGame) == null ? $opal.cm('TheGame') : $b))._scope).Settlement == null ? $a.cm('Settlement') : $a.Settlement).$instance().$get_job(person);
            if (job !== false && job !== nil) {
              return person['$action='](job)
              } else {
              return person.$do_stuff()
            };
            } else {
...
//# sourceMappingURL=/__opal_source_maps__/the_game/action/wonder_for_no_reason.js.map
;
/* Generated by Opal 0.6.2 */
(function($opal) {
  var self = $opal.top, $scope = $opal, nil = $opal.nil, $breaker = $opal.breaker, $slice = $opal.slice, $klass = $opal.klass;

  $opal.add_stubs(['$*', '$description', '$energy=', '$+', '$energy', '$energy_per_minute_when_sleeping', '$-', '$==']);
  return (function($base, $super) {
    function $TheGame(){};
    var self = $TheGame = $klass($base, $super, 'TheGame', $TheGame);
    ...
    return (function($base, $super) {
      ...
      return (function($base, $super) {
        function $Sleep(){};
        var self = $Sleep = $klass($base, $super, 'Sleep', $Sleep);

        var def = self._proto, $scope = self._scope;

        def.place = def.minutes_left = nil;
        def.$initialize = function(place) {
          var self = this;

          self.place = place;
          return self.minutes_left = (8)['$*'](60);
        };

        def.$description = function() {
          var self = this;

          return "sleeping in " + (self.place.$description());
        };

        def.$perform = function(person, map, time_in_minutes) {
          var $a, self = this;

          ($a = person, $a['$energy=']($a.$energy()['$+'](self.place.$energy_per_minute_when_sleeping()['$*'](time_in_minutes))));
          return self.minutes_left = self.minutes_left['$-'](time_in_minutes);
        };
...
//# sourceMappingURL=/__opal_source_maps__/the_game/action/sleep.js.map
;
/* Generated by Opal 0.6.2 */
(function($opal) {
  var self = $opal.top, $scope = $opal, nil = $opal.nil, $breaker = $opal.breaker, $slice = $opal.slice, $klass = $opal.klass;

  $opal.add_stubs(['$any?', '$waterskin', '$action=', '$create', '$find_closest_to', '$==', '$terrain', '$then']);
  return (function($base, $super) {
    function $TheGame(){};
    var self = $TheGame = $klass($base, $super, 'TheGame', $TheGame);
    ...
    return (function($base, $super) {
      ...
      return (function($base, $super) {
        function $LookForSomethingToDrink(){};
        var self = $LookForSomethingToDrink = $klass($base, $super, 'LookForSomethingToDrink', $LookForSomethingToDrink);
        ...
        def.$description = function() {
          ...
          return "looking for something to drink";
        };

        return (def.$perform = function(person, map, time_in_minutes) {
          var $a, $b, TMP_1, $c, self = this, closest = nil, action = nil;

          if ((($a = person.$waterskin()['$any?']()) !== nil && (!$a._isBoolean || $a == true))) {
            return person['$action=']((($a = ((($b = $scope.Action) == null ? $opal.cm('Action') : $b))._scope).DrinkFromWaterskin == null ? $a.cm('DrinkFromWaterskin') : $a.DrinkFromWaterskin).$create())
            } else {
            closest = ($a = ($b = map).$find_closest_to, $a._p = (TMP_1 = function(tile){var self = TMP_1._s || this;
if (tile == null) tile = nil;
            return tile.$terrain()['$==']("river")}, TMP_1._s = self, TMP_1), $a).call($b, person);
            action = (($a = ((($c = $scope.Action) == null ? $opal.cm('Action') : $c))._scope).GoTo == null ? $a.cm('GoTo') : $a.GoTo).$create(closest).$then((($a = ((($c = $scope.Action) == null ? $opal.cm('Action') : $c))._scope).DrinkFromRiver == null ? $a.cm('DrinkFromRiver') : $a.DrinkFromRiver).$create());
            return person['$action='](action);
          };
        }, nil) && 'perform';
      })(self, (($a = $scope.Action) == null ? $opal.cm('Action') : $a))
    })(self, null)
...
//# sourceMappingURL=/__opal_source_maps__/the_game/action/look_for_something_to_drink.js.map
;
/* Generated by Opal 0.6.2 */
(function($opal) {
  var self = $opal.top, $scope = $opal, nil = $opal.nil, $breaker = $opal.breaker, $slice = $opal.slice, $klass = $opal.klass, $hash2 = $opal.hash2;

  $opal.add_stubs(['$+', '$<', '$rand', '$*', '$new', '$add', '$inventory', '$stash', '$instance', '$create', '$action=', '$>']);
  return (function($base, $super) {
    function $TheGame(){};
    var self = $TheGame = $klass($base, $super, 'TheGame', $TheGame);
    ...
    return (function($base, $super) {
      ...
      return (function($base, $super) {
        function $CatchFish(){};
        var self = $CatchFish = $klass($base, $super, 'CatchFish', $CatchFish);

        var def = self._proto, $scope = self._scope;

        def.minutes_spent_already = nil;
        def.$initialize = function() {
          var self = this;

          return self.minutes_spent_already = 0;
        };

        def.$description = function() {
          var self = this;

          return "trying to catch fish";
        };
        ...
        return (def.$perform = function(person, map, time_in_minutes) {
          var $a, $b, self = this, catched_fish = nil, stash = nil, action = nil;

          self.minutes_spent_already = self.minutes_spent_already['$+'](time_in_minutes);
          if (self.$rand()['$<'](((0.02)['$*'](time_in_minutes)))) {
            catched_fish = (($a = ((($b = $scope.Item) == null ? $opal.cm('Item') : $b))._scope).Fish == null ? $a.cm('Fish') : $a.Fish).$new();
            person.$inventory().$add(catched_fish);
            stash = (($a = ((($b = $scope.TheGame) == null ? $opal.cm('TheGame') : $b))._scope).Settlement == null ? $a.cm('Settlement') : $a.Settlement).$instance().$stash();
            action = (($a = ((($b = $scope.Action) == null ? $opal.cm('Action') : $b))._scope).Carry == null ? $a.cm('Carry') : $a.Carry).$create(["fish", "fishing_rod"], $hash2(["to"], {"to": stash}));
            person['$action='](action);};
          if (self.minutes_spent_already['$>'](90)) {
            stash = (($a = ((($b = $scope.TheGame) == null ? $opal.cm('TheGame') : $b))._scope).Settlement == null ? $a.cm('Settlement') : $a.Settlement).$instance().$stash();
            return person['$action=']((($a = ((($b = $scope.Action) == null ? $opal.cm('Action') : $b))._scope).Carry == null ? $a.cm('Carry') : $a.Carry).$create("fishing_rod", $hash2(["to"], {"to": stash})));
            } else {
            return nil
          };
        }, nil) && 'perform';
...
//# sourceMappingURL=/__opal_source_maps__/the_game/action/catch_fish.js.map
;
/* Generated by Opal 0.6.2 */
(function($opal) {
  var self = $opal.top, $scope = $opal, nil = $opal.nil, $breaker = $opal.breaker, $slice = $opal.slice, $klass = $opal.klass, $hash2 = $opal.hash2;

  $opal.add_stubs(['$[]', '$then', '$create', '$new', '$description', '$is_a?', '$each', '$get', '$inventory', '$add']);
  return (function($base, $super) {
    function $TheGame(){};
    var self = $TheGame = $klass($base, $super, 'TheGame', $TheGame);
    ...
    return (function($base, $super) {
      ...
      return (function($base, $super) {
        function $Carry(){};
        var self = $Carry = $klass($base, $super, 'Carry', $Carry);

        var def = self._proto, $scope = self._scope;

        def.item_type = def.place = nil;
        $opal.defs(self, '$create', function(item_type, opts) {
          var $a, self = this, to = nil;

          to = opts['$[]']("to");
          return (($a = $scope.GoTo) == null ? $opal.cm('GoTo') : $a).$create(to).$then(self.$new(item_type, $hash2(["to"], {"to": to})));
        });

        def.$initialize = function(item_type, opts) {
          var self = this, to = nil;

          to = opts['$[]']("to");
          self.item_type = item_type;
          return self.place = to;
        };

        def.$description = function() {
          var self = this;

          return "carrying " + (self.item_type) + " to " + (self.place.$description()) + "...";
        };
        ...
        return (def.$perform = function(person, map, time_in_minutes) {
          var $a, $b, TMP_1, self = this, item = nil;

          if ((($a = self.item_type['$is_a?']((($b = $scope.Array) == null ? $opal.cm('Array') : $b))) !== nil && (!$a._isBoolean || $a == true))) {
            return ($a = ($b = self.item_type).$each, $a._p = (TMP_1 = function(type){var self = TMP_1._s || this, item = nil;
              if (self.place == null) self.place = nil;
if (type == null) type = nil;
            item = person.$inventory().$get(type);
              return self.place.$add(item);}, TMP_1._s = self, TMP_1), $a).call($b)
            } else {
            item = person.$inventory().$get(self.item_type);
            return self.place.$add(item);
          };
        }, nil) && 'perform';
      })(self, (($a = $scope.Action) == null ? $opal.cm('Action') : $a))
    })(self, null)
...
//# sourceMappingURL=/__opal_source_maps__/the_game/action/carry.js.map
;
/* Generated by Opal 0.6.2 */
(function($opal) {
  var self = $opal.top, $scope = $opal, nil = $opal.nil, $breaker = $opal.breaker, $slice = $opal.slice, $klass = $opal.klass;

  $opal.add_stubs(['$description', '$go_to', '$<', '$distance_to']);
  return (function($base, $super) {
    function $TheGame(){};
    var self = $TheGame = $klass($base, $super, 'TheGame', $TheGame);
    ...
    return (function($base, $super) {
      ...
      return (function($base, $super) {
        ...
        def.$description = function() {
          ...
          return "going to " + (self.place.$description()) + "...";
        };

        def.$perform = function(person, map, time_in_minutes) {
          var self = this;

          return person.$go_to(self.place);
        };

        return (def['$done?'] = function(person) {
          var self = this;

          return person.$distance_to(self.place)['$<'](2.0);
        }, nil) && 'done?';
      })(self, (($a = $scope.Action) == null ? $opal.cm('Action') : $a))
    })(self, null)
  })(self, null)
...
//# sourceMappingURL=/__opal_source_maps__/the_game/action/go_to.js.map
;
/* Generated by Opal 0.6.2 */
(function($opal) {
  var self = $opal.top, $scope = $opal, nil = $opal.nil, $breaker = $opal.breaker, $slice = $opal.slice, $klass = $opal.klass, $hash2 = $opal.hash2;

  $opal.add_stubs(['$stash', '$instance', '$then', '$create', '$new', '$find_closest_to', '$is_a?', '$content', '$action=']);
  return (function($base, $super) {
    function $TheGame(){};
    var self = $TheGame = $klass($base, $super, 'TheGame', $TheGame);
    ...
    return (function($base, $super) {
      ...
      return (function($base, $super) {
        function $LookForTreeToCut(){};
        var self = $LookForTreeToCut = $klass($base, $super, 'LookForTreeToCut', $LookForTreeToCut);
        ...
        $opal.defs(self, '$create', function() {
          ...
          stash = (($a = ((($b = $scope.TheGame) == null ? $opal.cm('TheGame') : $b))._scope).Settlement == null ? $a.cm('Settlement') : $a.Settlement).$instance().$stash();
          return (($a = ((($b = $scope.Action) == null ? $opal.cm('Action') : $b))._scope).Get == null ? $a.cm('Get') : $a.Get).$create("axe", $hash2(["from"], {"from": stash})).$then(self.$new());
        });

        def.$description = function() {
          var self = this;

          return "looking for tree to cut";
        };
        ...
        return (def.$perform = function(person, map, time_in_minutes) {
          var $a, $b, TMP_1, $c, self = this, closest_tree = nil;

          closest_tree = ($a = ($b = map).$find_closest_to, $a._p = (TMP_1 = function(tile){var self = TMP_1._s || this, $a, $b;
if (tile == null) tile = nil;
          ...
          if (closest_tree !== false && closest_tree !== nil) {
            return person['$action=']((($a = ((($c = $scope.Action) == null ? $opal.cm('Action') : $c))._scope).CutTree == null ? $a.cm('CutTree') : $a.CutTree).$create(closest_tree.$content()))
            } else {
            return nil
          };
        }, nil) && 'perform';
...
//# sourceMappingURL=/__opal_source_maps__/the_game/action/look_for_tree_to_cut.js.map
;
/* Generated by Opal 0.6.2 */
(function($opal) {
  var self = $opal.top, $scope = $opal, nil = $opal.nil, $breaker = $opal.breaker, $slice = $opal.slice, $klass = $opal.klass;

  $opal.add_stubs(['$instance', '$-', '$x', '$fireplace', '$y', '$new', '$each', '$fetch', '$+', '$<<', '$building=', '$fields=', '$create_building_event', '$dormitory=', '$do_stuff']);
  return (function($base, $super) {
    function $TheGame(){};
    var self = $TheGame = $klass($base, $super, 'TheGame', $TheGame);
    ...
    return (function($base, $super) {
      ...
      return (function($base, $super) {
        function $PlanDormitoryBuilding(){};
        var self = $PlanDormitoryBuilding = $klass($base, $super, 'PlanDormitoryBuilding', $PlanDormitoryBuilding);
        ...
        def.$description = function() {
          ...
          return "planning to build dormitory";
        };
        ...
        return (def.$perform = function(person, map, time_in_minutes) {
          var $a, $b, $c, TMP_1, self = this, settlement = nil, dormitory_x = nil, dormitory_y = nil, dormitory = nil, fields = nil;

          settlement = (($a = $scope.Settlement) == null ? $opal.cm('Settlement') : $a).$instance();
          dormitory_x = settlement.$fireplace().$x()['$-'](5);
          dormitory_y = settlement.$fireplace().$y()['$-'](1);
          dormitory = (($a = ((($b = ((($c = $scope.TheGame) == null ? $opal.cm('TheGame') : $c))._scope).Construction == null ? $b.cm('Construction') : $b.Construction))._scope).Dormitory == null ? $a.cm('Dormitory') : $a.Dormitory).$new(dormitory_x, dormitory_y);
          fields = [];
          ($a = ($b = [0, 1, 2, 3]).$each, $a._p = (TMP_1 = function(row){var self = TMP_1._s || this, $a, $b, TMP_2;
if (row == null) row = nil;
...
//# sourceMappingURL=/__opal_source_maps__/the_game/action/plan_dormitory_building.js.map
;
/* Generated by Opal 0.6.2 */
(function($opal) {
  var self = $opal.top, $scope = $opal, nil = $opal.nil, $breaker = $opal.breaker, $slice = $opal.slice, $klass = $opal.klass;

  $opal.add_stubs(['$minutes_to_eat', '$type', '$-', '$times', '$eat', '$==', '$do_stuff']);
  return (function($base, $super) {
    function $TheGame(){};
    var self = $TheGame = $klass($base, $super, 'TheGame', $TheGame);
    ...
    return (function($base, $super) {
      ...
      return (function($base, $super) {
        function $Eat(){};
        var self = $Eat = $klass($base, $super, 'Eat', $Eat);

        var def = self._proto, $scope = self._scope;

        def.food = def.minutes_spent_eating_left = nil;
        def.$initialize = function(food) {
          var self = this;

          self.food = food;
          return self.minutes_spent_eating_left = self.food.$minutes_to_eat();
        };

        def.$description = function() {
          var self = this;

          return "eating " + (self.food.$type());
        };

        return (def.$perform = function(person, map, time_in_minutes) {
          var $a, $b, TMP_1, self = this;

          self.minutes_spent_eating_left = self.minutes_spent_eating_left['$-'](time_in_minutes);
          ($a = ($b = time_in_minutes).$times, $a._p = (TMP_1 = function(){var self = TMP_1._s || this;
            if (self.food == null) self.food = nil;

          return person.$eat(self.food)}, TMP_1._s = self, TMP_1), $a).call($b);
          if (self.minutes_spent_eating_left['$=='](0)) {
            return person.$do_stuff()
            } else {
            return nil
          };
...
//# sourceMappingURL=/__opal_source_maps__/the_game/action/eat.js.map
;
/* Generated by Opal 0.6.2 */
(function($opal) {
  var self = $opal.top, $scope = $opal, nil = $opal.nil, $breaker = $opal.breaker, $slice = $opal.slice, $klass = $opal.klass;

  $opal.add_stubs(['$stash', '$instance', '$then', '$create', '$new', '$get', '$==', '$-', '$add']);
  return (function($base, $super) {
    function $TheGame(){};
    var self = $TheGame = $klass($base, $super, 'TheGame', $TheGame);
    ...
    return (function($base, $super) {
      ...
      return (function($base, $super) {
        function $Cook(){};
        var self = $Cook = $klass($base, $super, 'Cook', $Cook);

        var def = self._proto, $scope = self._scope;

        def.food_type = def.minutes_left = nil;
        $opal.defs(self, '$create', function(food_type) {
          var $a, self = this, stash = nil;

          stash = (($a = $scope.Settlement) == null ? $opal.cm('Settlement') : $a).$instance().$stash();
          return (($a = $scope.GoTo) == null ? $opal.cm('GoTo') : $a).$create(stash).$then(self.$new(food_type));
        });

        def.$initialize = function(food_type) {
          var $a, self = this, stash = nil;

          self.food_type = food_type;
          self.minutes_left = 20;
          stash = (($a = $scope.Settlement) == null ? $opal.cm('Settlement') : $a).$instance().$stash();
          return stash.$get(self.food_type);
        };
        ...
        return (def.$perform = function(person, map, time_in_minutes) {
          var $a, $b, self = this, stash = nil, cooked_fish = nil;

          self.minutes_left = self.minutes_left['$-'](time_in_minutes);
          if (self.minutes_left['$=='](0)) {
            stash = (($a = $scope.Settlement) == null ? $opal.cm('Settlement') : $a).$instance().$stash();
            cooked_fish = (($a = ((($b = $scope.Item) == null ? $opal.cm('Item') : $b))._scope).CookedFish == null ? $a.cm('CookedFish') : $a.CookedFish).$new();
            return stash.$add(cooked_fish);
            } else {
            return nil
          };
        }, nil) && 'perform';
...
//# sourceMappingURL=/__opal_source_maps__/the_game/action/cook.js.map
;
/* Generated by Opal 0.6.2 */
(function($opal) {
  var self = $opal.top, $scope = $opal, nil = $opal.nil, $breaker = $opal.breaker, $slice = $opal.slice, $klass = $opal.klass;

  $opal.add_stubs(['$then', '$create', '$new', '$x', '$y', '$has?', '$get', '$action=']);
  return (function($base, $super) {
    function $TheGame(){};
    var self = $TheGame = $klass($base, $super, 'TheGame', $TheGame);
    ...
    return (function($base, $super) {
      ...
      return (function($base, $super) {
        function $FetchFood(){};
        var self = $FetchFood = $klass($base, $super, 'FetchFood', $FetchFood);

        var def = self._proto, $scope = self._scope;

        def.food_provider = nil;
        $opal.defs(self, '$create', function(food_provider) {
          var $a, self = this;

          return (($a = $scope.GoTo) == null ? $opal.cm('GoTo') : $a).$create(food_provider).$then(self.$new(food_provider));
        });

        def.$initialize = function(food_provider) {
          var self = this;

          return self.food_provider = food_provider;
        };

        def.$description = function() {
          var self = this, x = nil, y = nil;

          x = self.food_provider.$x();
          y = self.food_provider.$y();
          return "fetching food at " + (x) + ", " + (y);
        };
        ...
        return (def.$perform = function(person, map, time_in_minutes) {
          ...
          if ((($a = self.food_provider['$has?']("berries")) !== nil && (!$a._isBoolean || $a == true))) {
            self.food_provider.$get("berries");
            return person['$action=']((($a = ((($b = $scope.Action) == null ? $opal.cm('Action') : $b))._scope).Harvest == null ? $a.cm('Harvest') : $a.Harvest).$create(self.food_provider));
            } else {
            return person['$action=']((($a = ((($b = $scope.Action) == null ? $opal.cm('Action') : $b))._scope).LookForFoodToHarvest == null ? $a.cm('LookForFoodToHarvest') : $a.LookForFoodToHarvest).$create())
          };
        }, nil) && 'perform';
      })(self, (($a = $scope.Action) == null ? $opal.cm('Action') : $a))
    })(self, null)
...
//# sourceMappingURL=/__opal_source_maps__/the_game/action/fetch_food.js.map
;
/* Generated by Opal 0.6.2 */
(function($opal) {
  var self = $opal.top, $scope = $opal, nil = $opal.nil, $breaker = $opal.breaker, $slice = $opal.slice, $klass = $opal.klass;

  $opal.add_stubs(['$safe_place_to_sleep', '$instance', '$then', '$create', '$action=']);
  return (function($base, $super) {
    function $TheGame(){};
    var self = $TheGame = $klass($base, $super, 'TheGame', $TheGame);
    ...
    return (function($base, $super) {
      ...
      return (function($base, $super) {
        function $LookForPlaceToSleep(){};
        var self = $LookForPlaceToSleep = $klass($base, $super, 'LookForPlaceToSleep', $LookForPlaceToSleep);
        ...
        def.$description = function() {
          ...
          return "going near fireplace to sleep";
        };

        return (def.$perform = function(person, map, time_in_minutes) {
          var $a, $b, self = this, safe_place_to_sleep = nil, job = nil;

          safe_place_to_sleep = (($a = ((($b = $scope.TheGame) == null ? $opal.cm('TheGame') : $b))._scope).Settlement == null ? $a.cm('Settlement') : $a.Settlement).$instance().$safe_place_to_sleep();
          job = (($a = $scope.GoTo) == null ? $opal.cm('GoTo') : $a).$create(safe_place_to_sleep).$then((($a = $scope.Sleep) == null ? $opal.cm('Sleep') : $a).$create(safe_place_to_sleep));
          return person['$action='](job);
        }, nil) && 'perform';
      })(self, (($a = $scope.Action) == null ? $opal.cm('Action') : $a))
    })(self, null)
...
//# sourceMappingURL=/__opal_source_maps__/the_game/action/look_for_place_to_sleep.js.map
;
/* Generated by Opal 0.6.2 */
(function($opal) {
  var self = $opal.top, $scope = $opal, nil = $opal.nil, $breaker = $opal.breaker, $slice = $opal.slice, $klass = $opal.klass;

  $opal.add_stubs(['$find_closest_to', '$is_a?', '$content', '$action=', '$create']);
  return (function($base, $super) {
    function $TheGame(){};
    var self = $TheGame = $klass($base, $super, 'TheGame', $TheGame);
    ...
    return (function($base, $super) {
      ...
      return (function($base, $super) {
        function $LookForFoodToHarvest(){};
        var self = $LookForFoodToHarvest = $klass($base, $super, 'LookForFoodToHarvest', $LookForFoodToHarvest);
...
if (tile == null) tile = nil;
          return tile.$content()['$is_a?']((($a = ((($b = $scope.Nature) == null ? $opal.cm('Nature') : $b))._scope).BerriesBush == null ? $a.cm('BerriesBush') : $a.BerriesBush))}, TMP_1._s = self, TMP_1), $a).call($b, person);
          if (closest !== false && closest !== nil) {
            return person['$action=']((($a = ((($c = $scope.Action) == null ? $opal.cm('Action') : $c))._scope).FetchFood == null ? $a.cm('FetchFood') : $a.FetchFood).$create(closest.$content()))
            } else {
            return nil
          };
        }, nil) && 'perform';
...
//# sourceMappingURL=/__opal_source_maps__/the_game/action/look_for_food_to_harvest.js.map
;
/* Generated by Opal 0.6.2 */
(function($opal) {
  var self = $opal.top, $scope = $opal, nil = $opal.nil, $breaker = $opal.breaker, $slice = $opal.slice, $klass = $opal.klass;

  $opal.add_stubs(['$stash', '$instance', '$then', '$create', '$new', '$check_stash', '$private', '$has?', '$get', '$action=']);
  return (function($base, $super) {
    function $TheGame(){};
    var self = $TheGame = $klass($base, $super, 'TheGame', $TheGame);
    ...
    return (function($base, $super) {
      ...
      return (function($base, $super) {
        ...
        var self = $LookForFood = $klass($base, $super, 'LookForFood', $LookForFood);
        ...
        $opal.defs(self, '$create', function() {
          ...
          stash = (($a = ((($b = $scope.TheGame) == null ? $opal.cm('TheGame') : $b))._scope).Settlement == null ? $a.cm('Settlement') : $a.Settlement).$instance().$stash();
          return (($a = $scope.GoTo) == null ? $opal.cm('GoTo') : $a).$create(stash).$then(self.$new());
        });
        ...
        def.$perform = function(person, map, time_in_minutes) {
          ...
          return self.$check_stash(person, map);
        };
        ...
        return (def.$check_stash = function(person, map) {
          var $a, $b, self = this, stash = nil, cooked_fish = nil, berries = nil;

          stash = (($a = ((($b = $scope.TheGame) == null ? $opal.cm('TheGame') : $b))._scope).Settlement == null ? $a.cm('Settlement') : $a.Settlement).$instance().$stash();
          if ((($a = stash['$has?']("cooked_fish")) !== nil && (!$a._isBoolean || $a == true))) {
            cooked_fish = stash.$get("cooked_fish");
            person['$action=']((($a = $scope.Eat) == null ? $opal.cm('Eat') : $a).$create(cooked_fish));
            return nil;
          } else if ((($a = stash['$has?']("berries")) !== nil && (!$a._isBoolean || $a == true))) {
            berries = stash.$get("berries");
            person['$action=']((($a = $scope.Eat) == null ? $opal.cm('Eat') : $a).$create(berries));
            return nil;
            } else {
            return person['$action=']((($a = ((($b = $scope.Action) == null ? $opal.cm('Action') : $b))._scope).LookForFoodToHarvest == null ? $a.cm('LookForFoodToHarvest') : $a.LookForFoodToHarvest).$create())
          };
...
//# sourceMappingURL=/__opal_source_maps__/the_game/action/look_for_food.js.map
;
/* Generated by Opal 0.6.2 */
(function($opal) {
  var self = $opal.top, $scope = $opal, nil = $opal.nil, $breaker = $opal.breaker, $slice = $opal.slice, $klass = $opal.klass, $hash2 = $opal.hash2;

  $opal.add_stubs(['$[]', '$can_carry_more?', '$has?', '$get', '$add', '$inventory', '$need?', '$then', '$create', '$description=', '$description']);
  return (function($base, $super) {
    function $TheGame(){};
    var self = $TheGame = $klass($base, $super, 'TheGame', $TheGame);
    ...
    return (function($base, $super) {
      ...
      return (function($base, $super) {
        function $Supply(){};
        var self = $Supply = $klass($base, $super, 'Supply', $Supply);

        var def = self._proto, $scope = self._scope, $a;

        (function($base, $super) {
          function $Load(){};
          var self = $Load = $klass($base, $super, 'Load', $Load);

          var def = self._proto, $scope = self._scope;

          def.item_type = def.from = nil;
          def.$initialize = function(item_type, opts) {
          ...
          return (def.$perform = function(person, map, time_in_minutes) {
            var $a, $b, $c, self = this, item = nil;

            while ((($b = ($c = person['$can_carry_more?'](self.item_type), $c !== false && $c !== nil ?self.from['$has?'](self.item_type) : $c)) !== nil && (!$b._isBoolean || $b == true))) {
            item = self.from.$get(self.item_type);
        ...
        (function($base, $super) {
          function $Unload(){};
          var self = $Unload = $klass($base, $super, 'Unload', $Unload);

          var def = self._proto, $scope = self._scope;

          def.to = def.item_type = nil;
          def.$initialize = function(item_type, opts) {
            var self = this, to = nil;
          ...
          return (def.$perform = function(person, map, time_in_minutes) {
            ...
            while ((($b = ($c = self.to['$need?'](self.item_type), $c !== false && $c !== nil ?person['$has?'](self.item_type) : $c)) !== nil && (!$b._isBoolean || $b == true))) {
            item = person.$get(self.item_type);
            self.to.$add(item);};
          }, nil) && 'perform';
        })(self, (($a = $scope.Action) == null ? $opal.cm('Action') : $a));

        return ($opal.defs(self, '$create', function(place, opts) {
          var $a, self = this, with$ = nil, from = nil, action = nil;

          with$ = opts['$[]']("with");
          from = opts['$[]']("from");
          action = (($a = $scope.GoTo) == null ? $opal.cm('GoTo') : $a).$create(from).$then((($a = $scope.Load) == null ? $opal.cm('Load') : $a).$create(with$, $hash2(["from"], {"from": from}))).$then((($a = $scope.GoTo) == null ? $opal.cm('GoTo') : $a).$create(place)).$then((($a = $scope.Unload) == null ? $opal.cm('Unload') : $a).$create(with$, $hash2(["to"], {"to": place})));
...
//# sourceMappingURL=/__opal_source_maps__/the_game/action/supply.js.map
;
/* Generated by Opal 0.6.2 */
(function($opal) {
  var self = $opal.top, $scope = $opal, nil = $opal.nil, $breaker = $opal.breaker, $slice = $opal.slice, $klass = $opal.klass, $hash2 = $opal.hash2;

  $opal.add_stubs(['$then', '$create', '$new', '$x', '$y', '$description', '$-', '$==', '$cut!', '$recently_cut_tree_at=', '$fetch', '$instance', '$action=', '$stash']);
  return (function($base, $super) {
    function $TheGame(){};
    var self = $TheGame = $klass($base, $super, 'TheGame', $TheGame);
    ...
    return (function($base, $super) {
      ...
      return (function($base, $super) {
        function $CutTree(){};
        var self = $CutTree = $klass($base, $super, 'CutTree', $CutTree);

        var def = self._proto, $scope = self._scope;

        def.tree = def.minutes_left = nil;
        $opal.defs(self, '$create', function(tree) {
          var $a, self = this;

          return (($a = $scope.GoTo) == null ? $opal.cm('GoTo') : $a).$create(tree).$then(self.$new(tree));
        });
        ...
        return (def.$perform = function(person, map, time_in_minutes) {
          ...
          if (self.minutes_left['$=='](0)) {
            self.tree['$cut!']();
            person['$recently_cut_tree_at='](map.$fetch(self.tree.$x(), self.tree.$y()));
            settlement = (($a = $scope.Settlement) == null ? $opal.cm('Settlement') : $a).$instance();
            return person['$action=']((($a = ((($b = $scope.Action) == null ? $opal.cm('Action') : $b))._scope).Carry == null ? $a.cm('Carry') : $a.Carry).$create("axe", $hash2(["to"], {"to": settlement.$stash()})));
            } else {
            return nil
          };
        }, nil) && 'perform';
...
//# sourceMappingURL=/__opal_source_maps__/the_game/action/cut_tree.js.map
;
/* Generated by Opal 0.6.2 */
(function($opal) {
  var self = $opal.top, $scope = $opal, nil = $opal.nil, $breaker = $opal.breaker, $slice = $opal.slice, $klass = $opal.klass;

  $opal.add_stubs(['$then', '$create', '$new', '$description', '$==', '$minutes_left', '$minutes_left=', '$-', '$status=']);
  return (function($base, $super) {
    function $TheGame(){};
    var self = $TheGame = $klass($base, $super, 'TheGame', $TheGame);
    ...
    return (function($base, $super) {
      ...
      return (function($base, $super) {
        ...
        def.building = nil;
        $opal.defs(self, '$create', function(building) {
          var $a, self = this;

          return (($a = $scope.GoTo) == null ? $opal.cm('GoTo') : $a).$create(building).$then(self.$new(building));
        });

        def.$initialize = function(building) {
          var self = this;

          return self.building = building;
        };
        ...
        def.$description = function() {
          ...
          return "building " + (self.building.$description());
        };

        def['$done?'] = function(person) {
          var self = this;

          return self.building.$minutes_left()['$=='](0);
        };

        return (def.$perform = function(person, map, time_in_minutes) {
          var $a, self = this;

          ($a = self.building, $a['$minutes_left=']($a.$minutes_left()['$-'](time_in_minutes)));
          if (self.building.$minutes_left()['$=='](0)) {
            return self.building['$status=']("done")
            } else {
            return nil
          };
        }, nil) && 'perform';
...
//# sourceMappingURL=/__opal_source_maps__/the_game/action/construction.js.map
;
/* Generated by Opal 0.6.2 */
(function($opal) {
  var self = $opal.top, $scope = $opal, nil = $opal.nil, $breaker = $opal.breaker, $slice = $opal.slice, $klass = $opal.klass, $hash2 = $opal.hash2;

  $opal.add_stubs(['$[]', '$then', '$create', '$new', '$x', '$y', '$type', '$get', '$add', '$inventory', '$do_stuff']);
  return (function($base, $super) {
    function $TheGame(){};
    var self = $TheGame = $klass($base, $super, 'TheGame', $TheGame);
    ...
    return (function($base, $super) {
      ...
      return (function($base, $super) {
        function $Get(){};
        var self = $Get = $klass($base, $super, 'Get', $Get);

        var def = self._proto, $scope = self._scope;

        def.place = def.item_type = def.next_action = def.done = nil;
        $opal.defs(self, '$create', function(item_type, opts) {
          var $a, self = this, from = nil;

          from = opts['$[]']("from");
          return (($a = $scope.GoTo) == null ? $opal.cm('GoTo') : $a).$create(from).$then(self.$new(item_type, $hash2(["from"], {"from": from})));
        });
        ...
        def.$description = function() {
          ...
          x = self.place.$x();
          y = self.place.$y();
          return "getting " + (self.item_type) + " from " + (x) + ", " + (y) + "...";
        };

        def.$type = function() {
          var $a, self = this;

          if ((($a = self.next_action) !== nil && (!$a._isBoolean || $a == true))) {
            return self.next_action.$type()
            } else {
            return "haul"
          };
        };
        ...
        return (def.$perform = function(person, map, time_in_minutes) {
          ...
          item = self.place.$get(self.item_type);
...
//# sourceMappingURL=/__opal_source_maps__/the_game/action/get.js.map
;
/* Generated by Opal 0.6.2 */
(function($opal) {
  var self = $opal.top, $scope = $opal, nil = $opal.nil, $breaker = $opal.breaker, $slice = $opal.slice, $klass = $opal.klass, $hash2 = $opal.hash2;

  $opal.add_stubs(['$x', '$y', '$==', '$new', '$add', '$inventory', '$stash', '$instance', '$action=', '$create', '$-']);
  return (function($base, $super) {
    function $TheGame(){};
    var self = $TheGame = $klass($base, $super, 'TheGame', $TheGame);
    ...
    return (function($base, $super) {
      ...
      return (function($base, $super) {
        function $Harvest(){};
        var self = $Harvest = $klass($base, $super, 'Harvest', $Harvest);

        var def = self._proto, $scope = self._scope;

        def.food_provider = def.minutes_left = nil;
        def.$initialize = function(food_provider) {
          var self = this;
        ...
        def.$description = function() {
          ...
          x = self.food_provider.$x();
          y = self.food_provider.$y();
          return "harvesting berries at " + (x) + ", " + (y);
        };

        return (def.$perform = function(person, map, time_in_minutes) {
          var $a, $b, self = this, harvested_food = nil, stash = nil;

          if (self.minutes_left['$=='](0)) {
            harvested_food = (($a = ((($b = $scope.Item) == null ? $opal.cm('Item') : $b))._scope).Berries == null ? $a.cm('Berries') : $a.Berries).$new();
            person.$inventory().$add(harvested_food);
            stash = (($a = ((($b = $scope.TheGame) == null ? $opal.cm('TheGame') : $b))._scope).Settlement == null ? $a.cm('Settlement') : $a.Settlement).$instance().$stash();
            return person['$action=']((($a = ((($b = $scope.Action) == null ? $opal.cm('Action') : $b))._scope).Carry == null ? $a.cm('Carry') : $a.Carry).$create("berries", $hash2(["to"], {"to": stash})));
            } else {
            return self.minutes_left = self.minutes_left['$-'](time_in_minutes)
          };
        }, nil) && 'perform';
...
//# sourceMappingURL=/__opal_source_maps__/the_game/action/harvest.js.map
;
/* Generated by Opal 0.6.2 */
(function($opal) {
  var self = $opal.top, $scope = $opal, nil = $opal.nil, $breaker = $opal.breaker, $slice = $opal.slice, $klass = $opal.klass, $hash2 = $opal.hash2;
...
(function($opal) {
  ...
  $opal.add_stubs(['$done_drinking?', '$do_stuff', '$any?', '$waterskin', '$get_drink', '$drink', '$find_closest_to', '$==', '$terrain', '$then', '$create', '$description=', '$action=']);
  return (function($base, $super) {
    function $TheGame(){};
    var self = $TheGame = $klass($base, $super, 'TheGame', $TheGame);
    ...
    return (function($base, $super) {
      ...
      return (function($base, $super) {
        function $DrinkFromWaterskin(){};
        var self = $DrinkFromWaterskin = $klass($base, $super, 'DrinkFromWaterskin', $DrinkFromWaterskin);
        ...
        def.$description = function() {
          ...
          return "drinking from waterskin";
        };

        def.$perform = function(person, map, time_in_minutes) {
          var $a, $b, TMP_1, $c, self = this, drink = nil, closest = nil, action = nil;

          if ((($a = person['$done_drinking?']()) !== nil && (!$a._isBoolean || $a == true))) {
            return person.$do_stuff()
          } else if ((($a = person.$waterskin()['$any?']()) !== nil && (!$a._isBoolean || $a == true))) {
...
if (tile == null) tile = nil;
            return tile.$terrain()['$==']("river")}, TMP_1._s = self, TMP_1), $a).call($b, person);
            action = (($a = ((($c = $scope.Action) == null ? $opal.cm('Action') : $c))._scope).GoTo == null ? $a.cm('GoTo') : $a.GoTo).$create(closest).$then((($a = ((($c = $scope.Action) == null ? $opal.cm('Action') : $c))._scope).DrinkFromRiver == null ? $a.cm('DrinkFromRiver') : $a.DrinkFromRiver).$create()).$then((($a = ((($c = $scope.Action) == null ? $opal.cm('Action') : $c))._scope).FillWaterskin == null ? $a.cm('FillWaterskin') : $a.FillWaterskin).$create());
...
//# sourceMappingURL=/__opal_source_maps__/the_game/action/drink_from_waterskin.js.map
;
/* Generated by Opal 0.6.2 */
(function($opal) {
  var self = $opal.top, $scope = $opal, nil = $opal.nil, $breaker = $opal.breaker, $slice = $opal.slice, $klass = $opal.klass;

  $opal.add_stubs(['$waterskin', '$!', '$full?', '$fill_with', '$new', '$do_stuff']);
  return (function($base, $super) {
    function $TheGame(){};
    var self = $TheGame = $klass($base, $super, 'TheGame', $TheGame);
    ...
    return (function($base, $super) {
      ...
      return (function($base, $super) {
        function $FillWaterskin(){};
        var self = $FillWaterskin = $klass($base, $super, 'FillWaterskin', $FillWaterskin);
        ...
        return (def.$perform = function(person, map, time_in_minutes) {
          var $a, $b, $c, self = this, waterskin = nil;

          waterskin = person.$waterskin();
          while ((($b = waterskin['$full?']()['$!']()) !== nil && (!$b._isBoolean || $b == true))) {
          waterskin.$fill_with((($b = ((($c = $scope.Item) == null ? $opal.cm('Item') : $c))._scope).Water == null ? $b.cm('Water') : $b.Water).$new())};
          return person.$do_stuff();
        }, nil) && 'perform';
      })(self, (($a = $scope.Action) == null ? $opal.cm('Action') : $a))
    })(self, null)
...
//# sourceMappingURL=/__opal_source_maps__/the_game/action/fill_waterskin.js.map
;
/* Generated by Opal 0.6.2 */
(function($opal) {
  var self = $opal.top, $scope = $opal, nil = $opal.nil, $breaker = $opal.breaker, $slice = $opal.slice, $klass = $opal.klass;
...
(function($opal) {
  ...
  $opal.add_stubs(['$include', '$==', '$>', '$-', '$new', '$!', '$empty?']);
  return (function($base, $super) {
    function $TheGame(){};
    var self = $TheGame = $klass($base, $super, 'TheGame', $TheGame);
    ...
    return (function($base, $super) {
      ...
      return (function($base, $super) {
        function $BerriesBush(){};
        var self = $BerriesBush = $klass($base, $super, 'BerriesBush', $BerriesBush);

        var def = self._proto, $scope = self._scope, $a;

        def.berries_count = nil;
        self.$include((($a = $scope.HasPosition) == null ? $opal.cm('HasPosition') : $a));
        ...
        def.$get = function(type) {
          ...
          if (type['$==']("berries")) {
            if (self.berries_count['$>'](0)) {
              ...
              return (($a = ((($b = $scope.Item) == null ? $opal.cm('Item') : $b))._scope).Berries == null ? $a.cm('Berries') : $a.Berries).$new();
              } else {
              return nil
            }
            } else {
...
//# sourceMappingURL=/__opal_source_maps__/the_game/nature/berries_bush.js.map
;
/* Generated by Opal 0.6.2 */
(function($opal) {
  var self = $opal.top, $scope = $opal, nil = $opal.nil, $breaker = $opal.breaker, $slice = $opal.slice, $klass = $opal.klass;

  $opal.add_stubs(['$include', '$==', '$!', '$empty?', '$>', '$-', '$new']);
  return (function($base, $super) {
    function $TheGame(){};
    var self = $TheGame = $klass($base, $super, 'TheGame', $TheGame);
    ...
    return (function($base, $super) {
      ...
      return (function($base, $super) {
        function $LogPile(){};
        var self = $LogPile = $klass($base, $super, 'LogPile', $LogPile);
        ...
        def.$get = function(type) {
          ...
          if (type['$==']("log")) {
            if (self.logs_count['$>'](0)) {
              ...
              return (($a = ((($b = $scope.Item) == null ? $opal.cm('Item') : $b))._scope).Log == null ? $a.cm('Log') : $a.Log).$new();
              } else {
              return nil
            }
            } else {
...
//# sourceMappingURL=/__opal_source_maps__/the_game/nature/log_pile.js.map
;
/* Generated by Opal 0.6.2 */
(function($opal) {
  var self = $opal.top, $scope = $opal, nil = $opal.nil, $breaker = $opal.breaker, $slice = $opal.slice, $klass = $opal.klass, $hash2 = $opal.hash2;

  $opal.add_stubs(['$attr_accessor', '$generate', '$new', '$generate_people!', '$people=', '$instance', '$remove_dead_people!', '$each', '$update', '$+', '$*', '$private', '$delete_if', '$dead?', '$/', '$height', '$map', '$width', '$<<']);
  return (function($base, $super) {
    function $TheGame(){};
    var self = $TheGame = $klass($base, $super, 'TheGame', $TheGame);
    ...
    return (function($base, $super) {
      ...
      def.people = def.map = def.time = nil;
      self.$attr_accessor("map", "people", "time");

      def.$initialize = function() {
        var $a, $b, self = this;

        self.map = (($a = ((($b = $scope.Map) == null ? $opal.cm('Map') : $b))._scope).Generator == null ? $a.cm('Generator') : $a.Generator).$new().$generate();
        self.people = [];
        self['$generate_people!']();
        (($a = ((($b = $scope.TheGame) == null ? $opal.cm('TheGame') : $b))._scope).Settlement == null ? $a.cm('Settlement') : $a.Settlement).$instance()['$people='](self.people);
        return self.time = (($a = $scope.Time) == null ? $opal.cm('Time') : $a).$new(1000, 1, 1, 12, 0, 0);
      };

      def.$update = function(time_in_minutes) {
        var $a, $b, TMP_1, $c, self = this;
        ...
        ($a = ($b = self.people).$each, $a._p = (TMP_1 = function(person){var self = TMP_1._s || this;
          if (self.map == null) self.map = nil;
if (person == null) person = nil;
        return person.$update(self.map, time_in_minutes)}, TMP_1._s = self, TMP_1), $a).call($b);
        (($a = ((($c = $scope.TheGame) == null ? $opal.cm('TheGame') : $c))._scope).Settlement == null ? $a.cm('Settlement') : $a.Settlement).$instance().$update(time_in_minutes);
        self.map.$update();
        return self.time = self.time['$+'](time_in_minutes['$*'](60));
      };

      self.$private();

      def['$remove_dead_people!'] = function() {
        var $a, $b, TMP_2, self = this;

        return ($a = ($b = self.people).$delete_if, $a._p = (TMP_2 = function(person){var self = TMP_2._s || this;
if (person == null) person = nil;
        return person['$dead?']()}, TMP_2._s = self, TMP_2), $a).call($b);
      };

      return (def['$generate_people!'] = function() {
        var $a, $b, self = this, x_center = nil, y_center = nil;

        x_center = self.$map().$height()['$/'](2);
        y_center = self.$map().$width()['$/'](2);
        self.people['$<<']((($a = ((($b = $scope.Person) == null ? $opal.cm('Person') : $b))._scope).Leader == null ? $a.cm('Leader') : $a.Leader).$new($hash2(["x", "y"], {"x": x_center, "y": y_center})));
        self.people['$<<']((($a = ((($b = $scope.Person) == null ? $opal.cm('Person') : $b))._scope).Woodcutter == null ? $a.cm('Woodcutter') : $a.Woodcutter).$new($hash2(["x", "y"], {"x": x_center, "y": y_center})));
        self.people['$<<']((($a = ((($b = $scope.Person) == null ? $opal.cm('Person') : $b))._scope).Gatherer == null ? $a.cm('Gatherer') : $a.Gatherer).$new($hash2(["x", "y"], {"x": x_center, "y": y_center})));
        self.people['$<<']((($a = ((($b = $scope.Person) == null ? $opal.cm('Person') : $b))._scope).Gatherer == null ? $a.cm('Gatherer') : $a.Gatherer).$new($hash2(["x", "y"], {"x": x_center, "y": y_center})));
        return self.people['$<<']((($a = ((($b = $scope.Person) == null ? $opal.cm('Person') : $b))._scope).Fisherman == null ? $a.cm('Fisherman') : $a.Fisherman).$new($hash2(["x", "y"], {"x": x_center, "y": y_center})));
      }, nil) && 'generate_people!';
    })(self, null)
  })(self, null)
})(Opal);

//# sourceMappingURL=/__opal_source_maps__/the_game/engine.js.map
;
/* Generated by Opal 0.6.2 */
(function($opal) {
  var self = $opal.top, $scope = $opal, nil = $opal.nil, $breaker = $opal.breaker, $slice = $opal.slice, $module = $opal.module;
...
(function($opal) {
  ...
  $opal.add_stubs(['$include', '$attr_accessor', '$each', '$==', '$!', '$fire_is_ok?', '$has?', '$create', '$needs_cleaning?', '$tile_for_cleaning', '$content', '$need_more_food?', '$then', '$need_more_wood?', '$need_wood?', '$status', '$nil?', '$can_start_building?', '$start_building!', '$do_stuff', '$ready_to_build?', '$accepted_jobs', '$*', '$+', '$firewood_needed', '$count', '$stash', '$<', '$food_amount', '$people_count', '$type', '$sleep_area', '$update', '$size']);
  ;
  return (function($base, $super) {
    function $TheGame(){};
    var self = $TheGame = $klass($base, $super, 'TheGame', $TheGame);
    ...
    return (function($base, $super) {
      function $Settlement(){};
      var self = $Settlement = $klass($base, $super, 'Settlement', $Settlement);

      var def = self._proto, $scope = self._scope, $a;

      def.dormitory = def.stash = def.jobs = def.fireplace = def.people = nil;
      self.$include((($a = $scope.Singleton) == null ? $opal.cm('Singleton') : $a));

      self.$attr_accessor("stash");

      self.$attr_accessor("people");

      self.$attr_accessor("firewood_needed");
...
if (job_type == null) job_type = nil;
        if ((($a = ($b = (($c = job_type['$==']("survival")) ? self.fireplace['$fire_is_ok?']()['$!']() : $c), $b !== false && $b !== nil ?self.stash['$has?']("firewood") : $b)) !== nil && (!$a._isBoolean || $a == true))) {
          ...
          } else if (job_type['$==']("gatherer")) {
            if ((($a = self['$needs_cleaning?']("gatherer")) !== nil && (!$a._isBoolean || $a == true))) {
              tile = self.dormitory.$tile_for_cleaning("gatherer");
              $opal.$return((($a = ((($b = $scope.Action) == null ? $opal.cm('Action') : $b))._scope).FetchFood == null ? $a.cm('FetchFood') : $a.FetchFood).$create(tile.$content()));
            } else if ((($a = self['$need_more_food?']()) !== nil && (!$a._isBoolean || $a == true))) {
              $opal.$return((($a = ((($b = $scope.Action) == null ? $opal.cm('Action') : $b))._scope).LookForFoodToHarvest == null ? $a.cm('LookForFoodToHarvest') : $a.LookForFoodToHarvest).$create())
              } else {
              return nil
            }
          } else if (job_type['$==']("woodcutting")) {
            if ((($a = self['$needs_cleaning?']("woodcutting")) !== nil && (!$a._isBoolean || $a == true))) {
            ...
            if ((($a = ($b = ($c = ($d = self.dormitory, $d !== false && $d !== nil ?self.dormitory['$need_wood?']() : $d), $c !== false && $c !== nil ?self.dormitory.$status()['$==']("plan") : $c), $b !== false && $b !== nil ?self.stash['$has?']("firewood") : $b)) !== nil && (!$a._isBoolean || $a == true))) {
          ...
          } else if (job_type['$==']("management")) {
            if ((($a = self.dormitory['$nil?']()) !== nil && (!$a._isBoolean || $a == true))) {
              $opal.$return((($a = ((($b = $scope.Action) == null ? $opal.cm('Action') : $b))._scope).PlanDormitoryBuilding == null ? $a.cm('PlanDormitoryBuilding') : $a.PlanDormitoryBuilding).$create())
            } else if ((($a = ($b = self.dormitory, $b !== false && $b !== nil ?self.dormitory['$can_start_building?']() : $b)) !== nil && (!$a._isBoolean || $a == true))) {
              self.dormitory['$start_building!']();
              return person.$do_stuff();
              } else {
              return nil
            }
          } else if ((($a = ($b = (($c = job_type['$==']("building")) ? self.dormitory : $c), $b !== false && $b !== nil ?self.dormitory['$ready_to_build?']() : $b)) !== nil && (!$a._isBoolean || $a == true))) {
            $opal.$return((($a = ((($b = $scope.Action) == null ? $opal.cm('Action') : $b))._scope).Construction == null ? $a.cm('Construction') : $a.Construction).$create(self.dormitory))
          } else if (job_type['$==']("fisherman")) {
            $opal.$return((($a = ((($b = $scope.Action) == null ? $opal.cm('Action') : $b))._scope).GoFishing == null ? $a.cm('GoFishing') : $a.GoFishing).$create())
          } else if ((($a = (($b = job_type['$==']("cooking")) ? self.stash['$has?']("fish") : $b)) !== nil && (!$a._isBoolean || $a == true))) {
            $opal.$return((($a = ((($b = $scope.Action) == null ? $opal.cm('Action') : $b))._scope).Cook == null ? $a.cm('Cook') : $a.Cook).$create("fish"))
            } else {
            return nil
          }}, TMP_1._s = self, TMP_1), $a).call($b);
        return nil;
      ...
      def['$needs_cleaning?'] = function(job_type) {
        ...
        return ($a = self.dormitory, $a !== false && $a !== nil ?self.dormitory['$needs_cleaning?'](job_type) : $a);
      };
      ...
      def['$need_more_food?'] = function() {
        var self = this;

        return self.stash.$food_amount()['$<'](self.$people_count());
      };
...
if (job == null) job = nil;
      ...
      def.$safe_place_to_sleep = function() {
        ...
        return ((($a = self.dormitory.$sleep_area()) !== false && $a !== nil) ? $a : self.fireplace.$sleep_area());
      };

      def.$update = function(minutes) {
        var self = this;

        return self.fireplace.$update(minutes);
      };

      def.$people_count = function() {
        var self = this;

        return self.people.$size();
      };

      return (def.$food_amount = function() {
        var self = this;

        return self.$stash().$food_amount();
      }, nil) && 'food_amount';
    })(self, null)
  })(self, null);
})(Opal);

//# sourceMappingURL=/__opal_source_maps__/the_game/settlement.js.map
;
/* Generated by Opal 0.6.2 */
(function($opal) {
  var self = $opal.top, $scope = $opal, nil = $opal.nil, $breaker = $opal.breaker, $slice = $opal.slice, $klass = $opal.klass;
...
//# sourceMappingURL=/__opal_source_maps__/the_game/construction.js.map
;
/* Generated by Opal 0.6.2 */
(function($opal) {
  var $a, self = $opal.top, $scope = $opal, nil = $opal.nil, $breaker = $opal.breaker, $slice = $opal.slice, $klass = $opal.klass, $gvars = $opal.gvars;
  ...
  (function($base, $super) {
    ...
    (function($base, $super) {
      ...
      def['$render_time!'] = function() {
        ...
        return self.time_window.$text(self.engine.$time());
      };
...
if (type == null) type = nil;if (count == null) count = nil;
    ...
    (function($base, $super) {
      ...
      return (def['$playing='] = function(value) {
        var self = this;
    ...
    (function($base, $super) {
      function $GameLoop(){};
      var self = $GameLoop = $klass($base, $super, 'GameLoop', $GameLoop);
      ...
      def.$initialize = function() {
        ...
        self.engine = (($a = ((($b = $scope.TheGame) == null ? $opal.cm('TheGame') : $b))._scope).Engine == null ? $a.cm('Engine') : $a.Engine).$new();
        self.menu = (($a = ((($b = $scope.TheGame) == null ? $opal.cm('TheGame') : $b))._scope).Menu == null ? $a.cm('Menu') : $a.Menu).$new(self.engine);
        self.window = (($a = ((($b = $scope.TheGame) == null ? $opal.cm('TheGame') : $b))._scope).Window == null ? $a.cm('Window') : $a.Window).$new();
        self.startButton = (($a = $scope.Element) == null ? $opal.cm('Element') : $a).$find("#start");
        self.playing = true;
        return self.turns_per_second = 30;
      };
