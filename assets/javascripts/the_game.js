  ...
  return (function($base, $super) {
    ...
    return (function($base, $super) {
      ...
      return (function($base, $super) {
        ...
        def.updated = def.mark_for_cleaning = def.terrain = def.content = def.x = def.y = nil;
        ...
        def['$updated?'] = function() {
          var self = this;

          return self.updated;
        };

        def['$need_update!'] = function() {
          var self = this;
        ...
        return (def.$update = function() {
          ...
          if ((($a = ($b = self.content['$is_a?']((($c = ((($d = $scope.Construction) == null ? $opal.cm('Construction') : $d))._scope).FallenTree == null ? $c.cm('FallenTree') : $c.FallenTree)), $b !== false && $b !== nil ?self.content['$empty?']() : $b)) !== nil && (!$a._isBoolean || $a == true))) {
            ...
            (($a = $scope.Settlement) == null ? $opal.cm('Settlement') : $a).$instance().$fallen_trees()['$<<'](fallen_tree);
            return self['$need_update!']();
            } else {
            return nil
          };
...
(function($opal) {
  ...
  $opal.add_stubs(['$include', '$attr_accessor', '$attr_reader', '$+', '$/', '$rand', '$do_stuff', '$new', '$nil?', '$[]', '$x=', '$y=', '$create', '$has?', '$get', '$!', '$==', '$raise', '$<', '$count', '$update_hunger', '$update_energy', '$update_thirst', '$perform', '$-', '$*', '$thirst', '$>', '$hunger', '$energy']);
  return (function($base, $super) {
    function $TheGame(){};
    var self = $TheGame = $klass($base, $super, 'TheGame', $TheGame);
    ...
    return (function($base, $super) {
      ...
      def.inventory = def.action = def.dead = def.hunger = def.thirst = def.energy = nil;
      self.$include((($a = ((($b = $scope.TheGame) == null ? $opal.cm('TheGame') : $b))._scope).HasPosition == null ? $a.cm('HasPosition') : $a.HasPosition));
...
(function($opal) {
  ...
  $opal.add_stubs(['$done_drinking?', '$thirst=', '$+', '$thirst']);
  return (function($base, $super) {
    function $TheGame(){};
    var self = $TheGame = $klass($base, $super, 'TheGame', $TheGame);
    ...
    return (function($base, $super) {
      ...
      return (function($base, $super) {
        ...
        return (def.$perform = function(person, map, time_in_minutes) {
          ...
          return ($a = person, $a['$thirst=']($a.$thirst()['$+'](0.05)));
        }, nil) && 'perform';
      })(self, (($a = $scope.Action) == null ? $opal.cm('Action') : $a))
    })(self, null)
  })(self, null)
...
(function($opal) {
  ...
  $opal.add_stubs(['$minutes_to_eat', '$type', '$-', '$hunger=', '$+', '$hunger', '$*', '$hunger_per_minute_added', '$==', '$do_stuff']);
  return (function($base, $super) {
    function $TheGame(){};
    var self = $TheGame = $klass($base, $super, 'TheGame', $TheGame);
    ...
    return (function($base, $super) {
      ...
      return (function($base, $super) {
        ...
        return (def.$perform = function(person, map, time_in_minutes) {
          ...
          ($a = person, $a['$hunger=']($a.$hunger()['$+'](self.food.$hunger_per_minute_added()['$*'](time_in_minutes))));
