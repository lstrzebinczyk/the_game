...
/* Generated by Opal 0.6.2 */
(function($opal) {
  var $a, $b, self = $opal.top, $scope = $opal, nil = $opal.nil, $breaker = $opal.breaker, $slice = $opal.slice, $klass = $opal.klass, time_begin = nil, iterations = nil, accessor = nil, accessor_read = nil, accessor_write = nil, definer = nil, definer_read = nil, definer_write = nil;

  $opal.add_stubs(['$attr_accessor', '$now', '$new', '$<', '$-', '$field', '$+', '$p', '$field=', '$/', '$to_f']);
  ;
  (function($base, $super) {
    function $Accessor(){};
  ...
  while ((($b = $scope.Time) == null ? $opal.cm('Time') : $b).$now()['$-'](time_begin)['$<'](2)) {
  accessor.$field();
  iterations = iterations['$+'](1);};
  accessor_read = iterations;
  self.$p("Accessor#field: " + (iterations));
  time_begin = (($a = $scope.Time) == null ? $opal.cm('Time') : $a).$now();
  iterations = 0;
  accessor = (($a = $scope.Accessor) == null ? $opal.cm('Accessor') : $a).$new();
  while ((($b = $scope.Time) == null ? $opal.cm('Time') : $b).$now()['$-'](time_begin)['$<'](2)) {
  ...
  self.$p("Definer#field: " + (iterations));
  time_begin = (($a = $scope.Time) == null ? $opal.cm('Time') : $a).$now();
  iterations = 0;
  definer = (($a = $scope.Definer) == null ? $opal.cm('Definer') : $a).$new();
  while ((($b = $scope.Time) == null ? $opal.cm('Time') : $b).$now()['$-'](time_begin)['$<'](2)) {
  ...
  self.$p("Definer#field=: " + (iterations));
  self.$p("Definer write is " + (definer_write.$to_f()['$/'](accessor_write)) + " times faster");
  return self.$p("Definer read is " + (definer_read.$to_f()['$/'](accessor_read)) + " times faster");
})(Opal);
