...
/* Generated by Opal 0.6.2 */
(function($opal) {
  var $a, $b, TMP_1, $c, TMP_2, $d, TMP_3, $e, TMP_4, self = $opal.top, $scope = $opal, nil = $opal.nil, $breaker = $opal.breaker, $slice = $opal.slice, $klass = $opal.klass, time_begin = nil, accessor = nil, accessor_read = nil, accessor_write = nil, definer = nil, definer_write = nil;

  $opal.add_stubs(['$attr_accessor', '$now', '$new', '$times', '$field', '$-', '$p', '$field=']);
  ;
  (function($base, $super) {
    function $Accessor(){};
    var self = $Accessor = $klass($base, $super, 'Accessor', $Accessor);

    var def = self._proto, $scope = self._scope;

    return self.$attr_accessor("field")
  })(self, null);
  (function($base, $super) {
    function $Definer(){};
    var self = $Definer = $klass($base, $super, 'Definer', $Definer);
    ...
    return (def['$field='] = function(field) {
      var self = this;

      return self.field = field;
    }, nil) && 'field=';
  })(self, null);
  time_begin = (($a = $scope.Time) == null ? $opal.cm('Time') : $a).$now();
  accessor = (($a = $scope.Accessor) == null ? $opal.cm('Accessor') : $a).$new();
  ($a = ($b = (10000000)).$times, $a._p = (TMP_1 = function(){var self = TMP_1._s || this;

  return accessor.$field()}, TMP_1._s = self, TMP_1), $a).call($b);
  accessor_read = (($a = $scope.Time) == null ? $opal.cm('Time') : $a).$now()['$-'](time_begin);
  self.$p("Accessor#field: " + (accessor_read));
  time_begin = (($a = $scope.Time) == null ? $opal.cm('Time') : $a).$now();
  accessor = (($a = $scope.Accessor) == null ? $opal.cm('Accessor') : $a).$new();
  ($a = ($c = (10000000)).$times, $a._p = (TMP_2 = function(){var self = TMP_2._s || this;

  return accessor['$field='](nil)}, TMP_2._s = self, TMP_2), $a).call($c);
  accessor_write = (($a = $scope.Time) == null ? $opal.cm('Time') : $a).$now()['$-'](time_begin);
  self.$p("Accessor#field=: " + (accessor_write));
  time_begin = (($a = $scope.Time) == null ? $opal.cm('Time') : $a).$now();
  definer = (($a = $scope.Definer) == null ? $opal.cm('Definer') : $a).$new();
  ($a = ($d = (10000000)).$times, $a._p = (TMP_3 = function(){var self = TMP_3._s || this;

  return definer.$field()}, TMP_3._s = self, TMP_3), $a).call($d);
  accessor_read = (($a = $scope.Time) == null ? $opal.cm('Time') : $a).$now()['$-'](time_begin);
  self.$p("Definer#field: " + (accessor_read));
  time_begin = (($a = $scope.Time) == null ? $opal.cm('Time') : $a).$now();
  definer = (($a = $scope.Definer) == null ? $opal.cm('Definer') : $a).$new();
  ($a = ($e = (10000000)).$times, $a._p = (TMP_4 = function(){var self = TMP_4._s || this;

  return definer['$field='](nil)}, TMP_4._s = self, TMP_4), $a).call($e);
  definer_write = (($a = $scope.Time) == null ? $opal.cm('Time') : $a).$now()['$-'](time_begin);
  return self.$p("Definer#field=: " + (definer_write));
})(Opal);

//# sourceMappingURL=/__opal_source_maps__/attr_accessor.js.map
;
